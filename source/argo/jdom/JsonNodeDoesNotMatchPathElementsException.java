...
public final class JsonNodeDoesNotMatchPathElementsException extends JsonNodeDoesNotMatchJsonNodeSelectorException {
   ...
   static JsonNodeDoesNotMatchPathElementsException jsonNodeDoesNotMatchPathElementsException(
      JsonNodeDoesNotMatchChainedJsonNodeSelectorException var0, Object[] var1, JsonRootNode var2
   ) {
   ...
   private static String formatMessage(JsonNodeDoesNotMatchChainedJsonNodeSelectorException var0, Object[] var1, JsonRootNode var2) {
      return "Failed to find "
         + var0.failedNode.toString()
         + " at ["
         + JsonNodeDoesNotMatchChainedJsonNodeSelectorException.getShortFormFailPath(var0.failPath)
         + "] while resolving ["
         + commaSeparate(var1)
         + "] in "
         + JSON_FORMATTER.format(var2)
         + ".";
   }
