...
public final class JsonNodeDoesNotMatchChainedJsonNodeSelectorException extends JsonNodeDoesNotMatchJsonNodeSelectorException {
   ...
   static JsonNodeDoesNotMatchJsonNodeSelectorException func_74701_a(Functor var0) {
      return new JsonNodeDoesNotMatchChainedJsonNodeSelectorException(var0, new LinkedList());
   }

   static JsonNodeDoesNotMatchJsonNodeSelectorException func_74699_a(JsonNodeDoesNotMatchChainedJsonNodeSelectorException var0, JsonNodeSelector var1) {
   ...
   static JsonNodeDoesNotMatchJsonNodeSelectorException func_74698_b(JsonNodeDoesNotMatchChainedJsonNodeSelectorException var0, JsonNodeSelector var1) {
