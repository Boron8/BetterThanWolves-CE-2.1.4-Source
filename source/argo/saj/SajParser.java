...
public final class SajParser {
   public void parse(Reader var1, JsonListener var2) {
   ...
   private void arrayString(PositionTrackingPushbackReader var1, JsonListener var2) {
   ...
   private void objectString(PositionTrackingPushbackReader var1, JsonListener var2) {
      char var3 = (char)this.readNextNonWhitespaceChar(var1);
      if (var3 != '{') {
         throw new InvalidSyntaxException("Expected object to start with { but got [" + var3 + "].", var1);
      } else {
   ...
   private void aFieldToken(PositionTrackingPushbackReader var1, JsonListener var2) {
      char var3 = (char)this.readNextNonWhitespaceChar(var1);
      if ('"' != var3) {
   ...
   private void aJsonValue(PositionTrackingPushbackReader var1, JsonListener var2) {
      char var3 = (char)this.readNextNonWhitespaceChar(var1);
      switch (var3) {
         case '"':
            var1.unread(var3);
   ...
   private String numberToken(PositionTrackingPushbackReader var1) {
   ...
   private String nonNegativeNumberToken(PositionTrackingPushbackReader var1) {
      StringBuilder var2 = new StringBuilder();
      char var3 = (char)var1.read();
      if ('0' == var3) {
         var2.append('0');
   ...
   private char nonZeroDigitToken(PositionTrackingPushbackReader var1) {
      char var3 = (char)var1.read();
      switch (var3) {
         case '1':
         case '2':
   ...
   private char digitToken(PositionTrackingPushbackReader var1) {
      char var3 = (char)var1.read();
      switch (var3) {
         case '0':
         case '1':
   ...
   private String digitString(PositionTrackingPushbackReader var1) {
      StringBuilder var2 = new StringBuilder();
      boolean var3 = false;
   ...
   private String possibleFractionalComponent(PositionTrackingPushbackReader var1) {
      StringBuilder var2 = new StringBuilder();
      char var3 = (char)var1.read();
      if (var3 == '.') {
         var2.append('.');
   ...
   private String possibleExponent(PositionTrackingPushbackReader var1) {
      StringBuilder var2 = new StringBuilder();
      char var3 = (char)var1.read();
      if (var3 != '.' && var3 != 'E') {
         var1.unread(var3);
   ...
   private String possibleSign(PositionTrackingPushbackReader var1) {
      StringBuilder var2 = new StringBuilder();
      char var3 = (char)var1.read();
      if (var3 != '+' && var3 != '-') {
         var1.unread(var3);
   ...
   private String stringToken(PositionTrackingPushbackReader var1) {
      StringBuilder var2 = new StringBuilder();
      char var3 = (char)var1.read();
      if ('"' != var3) {
   ...
   private char escapedStringChar(PositionTrackingPushbackReader var1) {
      char var3 = (char)var1.read();
      char var2;
      switch (var3) {
         case '"':
   ...
   private int hexadecimalNumber(PositionTrackingPushbackReader var1) {
      char[] var2 = new char[4];
      int var3 = var1.read(var2);
      if (var3 != 4) {
         throw new InvalidSyntaxException(
            "Expected a 4 digit hexidecimal number but got only [" + var3 + "], namely [" + String.valueOf(var2, 0, var3) + "].", var1
         );
      } else {
         try {
   ...
   private int readNextNonWhitespaceChar(PositionTrackingPushbackReader var1) {
      boolean var3 = false;
