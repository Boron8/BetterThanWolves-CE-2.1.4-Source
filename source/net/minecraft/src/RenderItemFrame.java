...
public class RenderItemFrame extends Render {
   ...
   private void renderFrameItemAsBlock(EntityItemFrame par1EntityItemFrame) {
      ...
      this.renderBlocksInstance
         .overrideBlockBounds(0.0, 0.5F - var5 + 0.0625F, 0.5F - var5 + 0.0625F, var3 * 0.5F, 0.5F + var5 - 0.0625F, 0.5F + var5 - 0.0625F);
   ...
   private void func_82402_b(EntityItemFrame par1EntityItemFrame) {
      ...
      if (var2 != null) {
         EntityItem var3 = (EntityItem)EntityList.createEntityOfType(EntityItem.class, par1EntityItemFrame.worldObj, 0.0, 0.0, 0.0, var2);
         var3.getEntityItem().stackSize = 1;
         var3.hoverStart = 0.0F;
         GL11.glPushMatrix();
         GL11.glTranslatef(
            -0.453125F * Direction.offsetX[par1EntityItemFrame.hangingDirection], -0.18F, -0.453125F * Direction.offsetZ[par1EntityItemFrame.hangingDirection]
         );
