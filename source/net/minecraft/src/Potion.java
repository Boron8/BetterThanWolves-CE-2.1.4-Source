...
public class Potion {
   ...
   public static final Potion heal = new PotionHealth(6, false, 16262179).b("potion.heal");
   public static final Potion harm = new PotionHealth(7, true, 4393481).b("potion.harm");
