...
public class StructureVillagePieces {
   ...
   private static int func_75079_a(List var0) {
      ...
      for (StructureVillagePieceWeight var4 : var0) {
   ...
   private static ComponentVillage func_75083_a(
      ComponentVillageStartPiece var0, StructureVillagePieceWeight var1, List var2, Random var3, int var4, int var5, int var6, int var7, int var8
   ) {
   ...
   private static ComponentVillage getNextVillageComponent(
      ComponentVillageStartPiece var0, List var1, Random var2, int var3, int var4, int var5, int var6, int var7
   ) {
      ...
      if (var8 <= 0) {
         ...
         while (var9 < 5) {
            ...
            for (StructureVillagePieceWeight var12 : var0.structureVillageWeightedPieceList) {
         ...
         return var14 != null ? new ComponentVillageTorch(var0, var7, var2, var14, var6) : null;
      }
   }
   ...
   private static StructureComponent getNextVillageStructureComponent(
      ...
      if (var7 > 50) {
         return null;
      } else if (Math.abs(var3 - var0.b().minX) <= 112 && Math.abs(var5 - var0.b().minZ) <= 112) {
