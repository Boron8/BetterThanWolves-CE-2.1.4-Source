...
public class ExtendedBlockStorage {
   ...
   public void setExtBlockID(int var1, int var2, int var3, int var4) {
      ...
      if (var5 == 0 && var4 != 0) {
         ...
         || Block.blocksList[var4] != null && Block.blocksList[var4].getTickRandomly()) {
         if ((Block.blocksList[var5] == null || !Block.blocksList[var5].getTickRandomly())
            && Block.blocksList[var4] != null
            && Block.blocksList[var4].getTickRandomly()) {
            this.tickRefCount++;
         }
      } else {
         this.tickRefCount--;
      ...
      this.blockLSBArray[var2 << 8 | var3 << 4 | var1] = (byte)(var4 & 0xFF);
      if (var4 > 255) {
         if (this.blockMSBArray == null) {
