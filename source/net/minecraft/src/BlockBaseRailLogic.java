...
public class BlockBaseRailLogic {
   ...
   private boolean isMinecartTrack(int var1, int var2, int var3) {
      if (BlockRailBase.isRailBlockAt(this.logicWorld, var1, var2, var3)) {
         return true;
      } else {
         return BlockRailBase.isRailBlockAt(this.logicWorld, var1, var2 + 1, var3) ? true : BlockRailBase.isRailBlockAt(this.logicWorld, var1, var2 - 1, var3);
      }
   }

   private BlockBaseRailLogic getRailLogic(ChunkPosition var1) {
      if (BlockRailBase.isRailBlockAt(this.logicWorld, var1.x, var1.y, var1.z)) {
         return new BlockBaseRailLogic(this.theRail, this.logicWorld, var1.x, var1.y, var1.z);
      } else if (BlockRailBase.isRailBlockAt(this.logicWorld, var1.x, var1.y + 1, var1.z)) {
         return new BlockBaseRailLogic(this.theRail, this.logicWorld, var1.x, var1.y + 1, var1.z);
      } else {
         return BlockRailBase.isRailBlockAt(this.logicWorld, var1.x, var1.y - 1, var1.z)
            ? new BlockBaseRailLogic(this.theRail, this.logicWorld, var1.x, var1.y - 1, var1.z)
            : null;
      }
   }
   ...
   private boolean canConnectTo(BlockBaseRailLogic var1) {
      if (this.isRailChunkPositionCorrect(var1)) {
         return true;
      } else if (this.railChunkPosition.size() == 2) {
         return false;
      } else {
         return this.railChunkPosition.isEmpty() ? true : true;
      }
   }
