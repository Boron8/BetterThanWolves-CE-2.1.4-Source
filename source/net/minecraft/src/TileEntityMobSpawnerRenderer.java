...
public class TileEntityMobSpawnerRenderer extends TileEntitySpecialRenderer {
   ...
   public static void func_98144_a(MobSpawnerBaseLogic var0, double var1, double var3, double var5, float var7) {
      ...
      if (var8 != null) {
         ...
         GL11.glRotatef((float)(var0.field_98284_d + (var0.field_98287_c - var0.field_98284_d) * var7) * 10.0F, 0.0F, 1.0F, 0.0F);
         GL11.glRotatef(-30.0F, 1.0F, 0.0F, 0.0F);
         GL11.glTranslatef(0.0F, -0.4F, 0.0F);
         GL11.glScalef(var9, var9, var9);
         var8.setLocationAndAngles(var1, var3, var5, 0.0F, 0.0F);
         RenderManager.instance.renderEntityWithPosYaw(var8, 0.0, 0.0, 0.0, 0.0F, var7);
      }
   }
}
