...
public class Chunk {
   ...
   public boolean sendUpdates = false;
   public int heightMapMinimum = 0;
   private int queuedLightChecks = 4096;
   boolean field_76653_p = false;
   ...
   public void generateSkylightMap() {
      ...
      for (int var2 = 0; var2 < 16; var2++) {
         for (int var3 = 0; var3 < 16; var3++) {
            ...
            if (!this.worldObj.provider.hasNoSky) {
               ...
               while (true) {
                  var9 -= this.getBlockLightOpacity(var2, var5, var3);
                  if (var9 > 0) {
                     ExtendedBlockStorage var6 = this.storageArrays[var5 >> 4];
                     if (var6 != null) {
                        var6.setExtSkylightValue(var2, var5 & 15, var3, var9);
      ...
      for (int var7 = 0; var7 < 16; var7++) {
         for (int var3 = 0; var3 < 16; var3++) {
            this.propagateSkylightOcclusion(var7, var3);
         }
      }
   }
   ...
   private void relightBlock(int par1, int par2, int par3) {
      int var4 = this.heightMap[par3 << 4 | par1] & 0xFF;
      int var5 = var4;
      if (par2 > var4) {
         var5 = par2;
      }
      ...
      if (var5 != var4) {
         ...
         if (!this.worldObj.provider.hasNoSky) {
            if (var5 < var4) {
               ...
               for (int var8x = var4; var8x < var5; var8x++) {
                  ExtendedBlockStorage var9 = this.storageArrays[var8x >> 4];
                  if (var9 != null) {
                     var9.setExtSkylightValue(par1, var8x & 15, par3, 0);
                     this.worldObj.markBlockForRenderUpdate((this.xPosition << 4) + par1, var8x, (this.zPosition << 4) + par3);
                  }
               }
            }
            ...
            while (var5 > 0 && var131 > 0) {
               int var12 = this.getBlockLightOpacity(par1, --var5, par3);
               if (var12 == 0) {
                  var12 = 1;
               }
               ...
               if (var10 != null) {
                  var10.setExtSkylightValue(par1, var5 & 15, par3, var131);
               }
            }
         }

         int var8xx = this.heightMap[par3 << 4 | par1];
         int var12x = var4;
         int var13 = var8xx;
         if (var8xx < var4) {
            var12x = var8xx;
         ...
         if (var8xx < this.heightMapMinimum) {
            this.heightMapMinimum = var8xx;
         }

         if (!this.worldObj.provider.hasNoSky) {
            this.updateSkylightNeighborHeight(var6 - 1, var7, var12x, var13);
            this.updateSkylightNeighborHeight(var6 + 1, var7, var12x, var13);
            this.updateSkylightNeighborHeight(var6, var7 - 1, var12x, var13);
            this.updateSkylightNeighborHeight(var6, var7 + 1, var12x, var13);
            this.updateSkylightNeighborHeight(var6, var7, var12x, var13);
         }
      ...
      if (var8 == par4 && var9 == par5) {
         ...
         if (var10.getExtBlockID(par1, par2 & 15, par3) != par4) {
            ...
            if (par4 != 0) {
               ...
               TileEntity var14x = this.getChunkBlockTileEntity(par1, par2, par3);
               if (var14x != null) {
                  var14x.updateContainingBlockInfo();
               }
            }
   ...
   public void fillChunk(byte[] par1ArrayOfByte, int par2, int par3, boolean par4) {
      ...
      for (TileEntity var11x : this.chunkTileEntityMap.values()) {
         var11x.updateContainingBlockInfo();
      }
   }
   ...
   public void enqueueRelightChecks() {
      for (int var1 = 0; var1 < 8; var1++) {
         ...
         for (int var7 = 0; var7 < 16; var7++) {
            ...
            if (this.storageArrays[var2] == null && (var7 == 0 || var7 == 15 || var3 == 0 || var3 == 15 || var4 == 0 || var4 == 15)
               || this.storageArrays[var2] != null && this.storageArrays[var2].getExtBlockID(var3, var7, var4) == 0) {
               int blockID = this.worldObj.getBlockId(var5, var8 - 1, var6);
   ...
   public void getClosestEntityMatchingCriteriaWithinRangeSq(ClosestEntityInfo closestEntityInfo) {
      for (int iVerticalIndex = closestEntityInfo.chunkEntityListMinVerticalIndex;
         iVerticalIndex <= closestEntityInfo.chunkEntityListMaxVerticalIndex;
         iVerticalIndex++
      ) {
         List tempEntityList = this.entityLists[iVerticalIndex];
         if (!tempEntityList.isEmpty()) {
            for (Entity tempEntity : tempEntityList) {
   ...
   public int getBlockNaturalLightValue(int x, int y, int z, int skylightSubtracted) {
      ...
      if (blockStorage != null) {
         ...
         return !this.worldObj.provider.hasNoSky && skylightSubtracted < EnumSkyBlock.Sky.defaultLightValue
            ? EnumSkyBlock.Sky.defaultLightValue - skylightSubtracted
            : 0;
      }
   }
   ...
   public int getBlockLightValueNoSky(int x, int y, int z) {
      ExtendedBlockStorage blockStorage = this.storageArrays[y >> 4];
      return blockStorage == null ? 0 : blockStorage.getExtBlocklightValue(x, y & 15, z);
   }
}
