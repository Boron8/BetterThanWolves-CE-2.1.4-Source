...
public class BlockStem extends BlockFlower {
         ...
         if (par5Random.nextInt((int)(25.0F / var6) + 1) == 0) {
            ...
            if (var7 < 7) {
               ...
               if (par1World.getBlockId(var9, par3, var10) == 0
                  && (var11 == Block.tilledField.blockID || var11 == Block.dirt.blockID || var11 == Block.grass.blockID)) {
   ...
   public int colorMultiplier(IBlockAccess par1IBlockAccess, int par2, int par3, int par4) {
      return ColorizeBlock.colorizeBlock(this, par1IBlockAccess, par2, par3, par4)
         ...
         : this.getRenderColor(par1IBlockAccess.getBlockMetadata(par2, par3, par4));
   }
   ...
   public int getState(IBlockAccess par1IBlockAccess, int par2, int par3, int par4) {
      ...
      return var5 < 7
         ? -1
         : (
            par1IBlockAccess.getBlockId(par2 - 1, par3, par4) == this.fruitType.blockID
               ? 0
               : (
                  par1IBlockAccess.getBlockId(par2 + 1, par3, par4) == this.fruitType.blockID
                     ? 1
                     : (
                        par1IBlockAccess.getBlockId(par2, par3, par4 - 1) == this.fruitType.blockID
                           ? 2
                           : (par1IBlockAccess.getBlockId(par2, par3, par4 + 1) == this.fruitType.blockID ? 3 : -1)
                     )
               )
         );
   }
