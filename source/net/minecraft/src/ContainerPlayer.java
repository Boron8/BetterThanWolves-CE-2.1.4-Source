...
public class ContainerPlayer extends Container {
   ...
   public ContainerPlayer(InventoryPlayer par1InventoryPlayer, boolean par2, EntityPlayer par3EntityPlayer) {
      ...
      this.a(new SlotCrafting(par1InventoryPlayer.player, this.craftMatrix, this.craftResult, 0, 144, 36));
      ...
      for (int var6 = 0; var6 < 4; var6++) {
         this.a(new SlotArmor(this, par1InventoryPlayer, par1InventoryPlayer.getSizeInventory() - 1 - var6, 8, 8 + var6 * 18, var6));
      }

      for (int var7 = 0; var7 < 3; var7++) {
         for (int var5 = 0; var5 < 9; var5++) {
            this.a(new Slot(par1InventoryPlayer, var5 + (var7 + 1) * 9, 8 + var5 * 18, 84 + var7 * 18));
         }
      }
