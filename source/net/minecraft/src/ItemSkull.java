...
public class ItemSkull extends Item {
   ...
   public static final String[] field_94587_a = new String[]{
      "skull_skeleton", "skull_wither", "skull_zombie", "skull_char", "skull_creeper", "fcItemSkullInfused"
   };
   ...
   public boolean onItemUse(
      ...
      if (par7 == 0) {
         ...
         if (!par2EntityPlayer.canPlayerEdit(par4, par5, par6, par7, par1ItemStack)) {
            ...
            int var11 = 0;
            if (par7 == 1) {
               var11 = MathHelper.floor_double(par2EntityPlayer.rotationYaw * 16.0F / 360.0F + 0.5) & 15;
            }
