...
public class ContainerBrewingStand extends Container {
   ...
   public ContainerBrewingStand(InventoryPlayer par1InventoryPlayer, TileEntityBrewingStand par2TileEntityBrewingStand) {
      ...
      this.a(new SlotBrewingStandPotion(par1InventoryPlayer.player, par2TileEntityBrewingStand, 0, 56, 46));
      this.a(new SlotBrewingStandPotion(par1InventoryPlayer.player, par2TileEntityBrewingStand, 1, 79, 53));
      this.a(new SlotBrewingStandPotion(par1InventoryPlayer.player, par2TileEntityBrewingStand, 2, 102, 46));
      this.theSlot = this.a(new SlotBrewingStandIngredient(this, par2TileEntityBrewingStand, 3, 79, 17));
      ...
      for (int var5 = 0; var5 < 9; var5++) {
         this.a(new Slot(par1InventoryPlayer, var5, 8 + var5 * 18, 142));
      }
   }
