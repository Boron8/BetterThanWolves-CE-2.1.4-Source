...
public class EntityAIBreakDoor extends EntityAIDoorInteract {
   ...
   public boolean shouldExecute() {
      if (!super.shouldExecute()) {
         ...
         return !this.theEntity.worldObj.getGameRules().getGameRuleBooleanValue("mobGriefing")
            ? false
            : !this.targetDoor.isDoorOpen(this.theEntity.worldObj, this.entityPosX, this.entityPosY, this.entityPosZ);
      }
   }
   ...
   public boolean continueExecuting() {
      double var1 = this.theEntity.e(this.entityPosX, this.entityPosY, this.entityPosZ);
