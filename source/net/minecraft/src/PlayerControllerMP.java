...
public class PlayerControllerMP {
   ...
   public static void clickBlockCreative(Minecraft par0Minecraft, PlayerControllerMP par1PlayerControllerMP, int par2, int par3, int par4, int par5) {
      if (!par0Minecraft.theWorld.a(par0Minecraft.thePlayer, par2, par3, par4, par5)) {
   ...
   public boolean onPlayerDestroyBlock(int par1, int par2, int par3, int par4) {
      if (this.currentGameType.isAdventure() && !this.mc.thePlayer.e(par1, par2, par3)) {
         return false;
      } else if (this.blockHitDelay > 0 && !this.currentGameType.isCreative()) {
         return false;
      } else {
         WorldClient var5 = this.mc.theWorld;
         Block var6 = Block.blocksList[var5.a(par1, par2, par3)];
         if (var6 == null) {
            return false;
         } else {
            var5.e(2001, par1, par2, par3, var6.blockID + (var5.h(par1, par2, par3) << 12));
            int var7 = var5.h(par1, par2, par3);
            boolean var8 = false;
            if (!this.currentGameType.isCreative()
               && !this.mc.thePlayer.canHarvestBlock(var6, par1, par2, par3)
               && var6.canConvertBlock(this.mc.thePlayer.cd(), var5, par1, par2, par3)) {
               var8 = var6.convertBlock(this.mc.thePlayer.cd(), var5, par1, par2, par3, par4);
            }

            if (!var8) {
               var8 = var5.i(par1, par2, par3);
               if (var8) {
      ...
      if (!this.mc.thePlayer.bX()) {
         if (!this.currentGameType.isAdventure() || this.mc.thePlayer.e(par1, par2, par3)) {
            if (this.currentGameType.isCreative()) {
               ...
               float fMiningSpeedModifier = this.mc.thePlayer.updateMiningSpeedModifier();
               this.netClientHandler.addToSendQueue(new StartBlockHarvestPacket(par1, par2, par3, par4, fMiningSpeedModifier));
               int var5 = this.mc.theWorld.a(par1, par2, par3);
               ...
               if (var5 > 0 && Block.blocksList[var5].getPlayerRelativeBlockHardness(this.mc.thePlayer, this.mc.thePlayer.worldObj, par1, par2, par3) >= 1.0F) {
                  ...
                  this.field_85183_f = this.mc.thePlayer.bG();
                  this.curBlockDamageMP = 0.0F;
                  this.stepSoundTickCounter = 0.0F;
                  this.mc
                     .theWorld
                     .f(this.mc.thePlayer.entityId, this.currentBlockX, this.currentBlockY, this.currentblockZ, (int)(this.curBlockDamageMP * 10.0F) - 1);
               }
            }
         }
      }
   ...
   public void resetBlockRemoving() {
      ...
      this.curBlockDamageMP = 0.0F;
      this.mc.theWorld.f(this.mc.thePlayer.entityId, this.currentBlockX, this.currentBlockY, this.currentblockZ, -1);
   }
         ...
         if (this.currentGameType.isCreative()) {
            ...
            if (this.sameToolAndBlock(par1, par2, par3)) {
               ...
               this.curBlockDamageMP = this.curBlockDamageMP
                  + var6.getPlayerRelativeBlockHardness(this.mc.thePlayer, this.mc.thePlayer.worldObj, par1, par2, par3);
               ...
               if (this.stepSoundTickCounter % 4.0F == 0.0F && var6 != null) {
                  this.mc
                     ...
                     .playSound(
                        ...
                        par2 + 0.5F,
                        par3 + 0.5F,
                        (stepSound.getStepVolume() + 1.0F) / 8.0F,
                        stepSound.getStepPitch() * 0.5F
                     );
               }
   ...
   private boolean sameToolAndBlock(int par1, int par2, int par3) {
      ItemStack var4 = this.mc.thePlayer.bG();
      ...
      if (this.field_85183_f != null && var4 != null) {
         var5 = var4.itemID == this.field_85183_f.itemID
            && ItemStack.areItemStackTagsEqual(var4, this.field_85183_f)
            && (var4.isItemStackDamageable() || var4.getItemDamage() == this.field_85183_f.getItemDamage());
      }
   ...
   public boolean onPlayerRightClick(
      EntityPlayer par1EntityPlayer, World par2World, ItemStack par3ItemStack, int par4, int par5, int par6, int par7, Vec3 par8Vec3
   ) {
      this.syncCurrentPlayItem();
   ...
   private void onBlockBrokenClientSide(int iBlockID, int iBlockI, int iBlockJ, int iBlockK, int iBlockMetadata) {
      float fExhaustionConsumed = 1.0F;
      ItemStack currentItemStack = this.mc.thePlayer.inventory.mainInventory[this.mc.thePlayer.inventory.currentItem];
      if (currentItemStack != null) {
         fExhaustionConsumed = currentItemStack.getItem()
            .getExhaustionOnUsedToHarvestBlock(iBlockID, this.mc.theWorld, iBlockI, iBlockJ, iBlockK, iBlockMetadata);
      }

      if (fExhaustionConsumed > 0.0F) {
         this.mc.thePlayer.exhaustionAddedSinceLastGuiUpdate = true;
      }
   }
