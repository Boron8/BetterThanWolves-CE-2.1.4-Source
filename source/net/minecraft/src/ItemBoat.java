...
public class ItemBoat extends Item {
   ...
   public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer) {
      ...
      double var9 = par3EntityPlayer.prevPosY + (par3EntityPlayer.posY - par3EntityPlayer.prevPosY) * var4 + 1.62 - par3EntityPlayer.yOffset;
      ...
      if (var24 == null) {
         ...
         Vec3 var25 = par3EntityPlayer.i(var4);
         boolean var26 = false;
         float var27 = 1.0F;
         ...
         if (var26) {
            ...
            if (var24.typeOfHit == EnumMovingObjectType.TILE) {
               int var32 = var24.blockX;
               int var33 = var24.blockY;
               int var34 = var24.blockZ;
               if (par2World.getBlockId(var32, var33, var34) == Block.snow.blockID) {
                  var33--;
               }

               EntityBoat var35 = (EntityBoat)EntityList.createEntityOfType(
                  EntityBoat.class, par2World, (double)(var32 + 0.5F), (double)(var33 + 1.0F), (double)(var34 + 0.5F)
               );
               var35.rotationYaw = ((MathHelper.floor_double(par3EntityPlayer.rotationYaw * 4.0F / 360.0F + 0.5) & 3) - 1) * 90;
