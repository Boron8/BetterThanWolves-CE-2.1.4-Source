...
public class ModelIronGolem extends ModelBase {
   ...
   public void setRotationAngles(float var1, float var2, float var3, float var4, float var5, float var6, Entity var7) {
      this.ironGolemHead.rotateAngleY = var4 / (180.0F / (float)Math.PI);
      this.ironGolemHead.rotateAngleX = var5 / (180.0F / (float)Math.PI);
   ...
   public void setLivingAnimations(EntityLiving var1, float var2, float var3, float var4) {
      ...
      if (var6 > 0) {
         this.ironGolemRightArm.rotateAngleX = -2.0F + 1.5F * this.func_78172_a(var6 - var4, 10.0F);
         this.ironGolemLeftArm.rotateAngleX = -2.0F + 1.5F * this.func_78172_a(var6 - var4, 10.0F);
      } else {
