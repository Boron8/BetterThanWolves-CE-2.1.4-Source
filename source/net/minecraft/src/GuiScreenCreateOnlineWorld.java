...
public class GuiScreenCreateOnlineWorld extends GuiScreen {
   ...
   public void drawScreen(int var1, int var2, float var3) {
      ...
      this.e();
      this.a(this.fontRenderer, var4.translateKey("mco.selectServer.create"), this.width / 2, 11, 16777215);
      this.b(this.fontRenderer, var4.translateKey("mco.configure.world.name"), this.width / 2 - 100, 52, 10526880);
      this.b(this.fontRenderer, var4.translateKey("mco.configure.world.seed"), this.width / 2 - 100, 98, 10526880);
      if (this.field_96256_r) {
         this.a(this.fontRenderer, this.field_96254_s, this.width / 2, 167, 16711680);
      }
