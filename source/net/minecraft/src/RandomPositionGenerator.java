...
public class RandomPositionGenerator {
   ...
   private static Vec3 findRandomTargetBlock(EntityCreature par0EntityCreature, int par1, int par2, Vec3 par3Vec3) {
      Random var4 = par0EntityCreature.aE();
      boolean var5 = false;
      int var6 = 0;
      int var7 = 0;
      int var8 = 0;
      float var9 = -99999.0F;
      boolean var10;
      if (par0EntityCreature.aP()) {
         double var11 = par0EntityCreature.aM()
               .getDistanceSquared(
            ...
            + 4.0F;
         double var13 = par0EntityCreature.aN() + par1;
      ...
      for (int var16 = 0; var16 < 10; var16++) {
         ...
         if (par3Vec3 == null || var12 * par3Vec3.xCoord + var14 * par3Vec3.zCoord >= 0.0) {
            ...
            if (!var10 || par0EntityCreature.d(var12, var17, var14)) {
      ...
      return var5 ? par0EntityCreature.worldObj.getWorldVec3Pool().getVecFromPool(var6, var7, var8) : null;
   }
}
