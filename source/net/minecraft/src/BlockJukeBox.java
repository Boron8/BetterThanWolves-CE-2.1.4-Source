      ...
      if (!par1World.isRemote) {
         ...
         if (var5 != null) {
            ...
            if (var6 != null) {
               ...
               float var7 = 0.7F;
               double var8 = par1World.rand.nextFloat() * var7 + (1.0F - var7) * 0.5;
               double var10 = par1World.rand.nextFloat() * var7 + (1.0F - var7) * 0.2 + 0.6;
               double var12 = par1World.rand.nextFloat() * var7 + (1.0F - var7) * 0.5;
               ItemStack var14 = var6.copy();
               EntityItem var15 = (EntityItem)EntityList.createEntityOfType(EntityItem.class, par1World, par2 + var8, par3 + var10, par4 + var12, var14);
