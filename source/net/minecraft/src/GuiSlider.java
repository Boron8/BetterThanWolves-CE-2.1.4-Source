...
public class GuiSlider extends GuiButton {
   ...
   protected void mouseDragged(Minecraft var1, int var2, int var3) {
      if (this.drawButton) {
         ...
         this.b(this.xPosition + (int)(this.sliderValue * (this.width - 8)), this.yPosition, 0, 66, 4, 20);
         this.b(this.xPosition + (int)(this.sliderValue * (this.width - 8)) + 4, this.yPosition, 196, 66, 4, 20);
      }
   }
