   ...
   private void fallIfPossible(World par1World, int par2, int par3, int par4) {
      if (BlockSand.canFallBelow(par1World, par2, par3 - 1, par4) && par3 >= 0) {
         ...
         if (!BlockSand.fallInstantly && par1World.checkChunksExist(par2 - var5, par3 - var5, par4 - var5, par2 + var5, par3 + var5, par4 + var5)) {
            EntityFallingSand var6 = (EntityFallingSand)EntityList.createEntityOfType(
               EntityFallingSand.class, par1World, (double)(par2 + 0.5F), (double)(par3 + 0.5F), (double)(par4 + 0.5F), this.blockID
            );
            ...
            if (par1World.getBlockId(var6, var7, var8) == 0) {
               if (!par1World.isRemote) {
                  ...
                  for (int var10 = 0; var10 < var9; var10++) {
                     ...
                     double var16 = var6 + (par2 - var6) * var11 + (par1World.rand.nextDouble() - 0.5) * 1.0 + 0.5;
                     double var18 = var7 + (par3 - var7) * var11 + par1World.rand.nextDouble() * 1.0 - 0.5;
                     double var20 = var8 + (par4 - var8) * var11 + (par1World.rand.nextDouble() - 0.5) * 1.0 + 0.5;
