...
public class ItemFirework extends Item {
   ...
   public boolean onItemUse(
      ...
      if (!par3World.isRemote) {
         EntityFireworkRocket var11 = (EntityFireworkRocket)EntityList.createEntityOfType(
            EntityFireworkRocket.class, par3World, (double)(par4 + par8), (double)(par5 + par9), (double)(par6 + par10), par1ItemStack
         );
