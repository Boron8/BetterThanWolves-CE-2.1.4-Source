...
public class FontRenderer {
      ...
      for (int var6 = 0; var6 < 256; var6++) {
         ...
         for (var9 = 7; var9 >= 0; var9--) {
            ...
            for (int var12 = 0; var12 < 8 && var11; var12++) {
               ...
               int var14 = var5[var10 + var13] & 0xFF;
               if (var14 > 0) {
                  var11 = false;
               }
            }
   ...
   private float renderCharAtPos(int par1, char par2, boolean par3) {
      return par2 == ' ' ? this.charWidthf[32] : (par1 > 0 && !this.unicodeFlag ? this.renderDefaultChar(par1 + 32, par3) : this.renderUnicodeChar(par2, par3));
   }
   ...
   private void loadGlyphTexture(int par1) {
      String var2 = String.format("/font/glyph_%02X.png", par1);
      ...
      if (par1Str != null && Bidi.requiresBidi(par1Str.toCharArray(), 0, par1Str.length())) {
         ...
         for (int var7 = 0; var7 < var4.length; var7++) {
            ...
            if ((var13 & 1) == 0) {
               ...
               for (int var16 = var4[var7].length() - 1; var16 >= 0; var16--) {
                  char var10 = var4[var7].charAt(var16);
                  if (var10 == '(') {
                     var10 = ')';
                  } else if (var10 == ')') {
                     var10 = '(';
      ...
      for (int var3 = 0; var3 < par1Str.length(); var3++) {
         ...
         if (var4 == 167 && var3 + 1 < par1Str.length()) {
            ...
            if (var5 < 16) {
               ...
               int var6 = ColorizeWorld.colorizeText(this.colorCode[var5], var5);
               this.textColor = var6;
            ...
            if (this.strikethroughStyle) {
               ...
               var9.addVertex(this.posX, this.posY + this.FONT_HEIGHT / 2, 0.0);
               var9.addVertex(this.posX + var8, this.posY + this.FONT_HEIGHT / 2, 0.0);
               var9.addVertex(this.posX + var8, this.posY + this.FONT_HEIGHT / 2 - 1.0F, 0.0);
               var9.addVertex(this.posX, this.posY + this.FONT_HEIGHT / 2 - 1.0F, 0.0);
               var9.draw();
               GL11.glEnable(3553);
            }
            ...
            if (this.underlineStyle) {
               ...
               var9.addVertex(this.posX + var10, this.posY + this.FONT_HEIGHT, 0.0);
               var9.addVertex(this.posX + var8, this.posY + this.FONT_HEIGHT, 0.0);
               var9.addVertex(this.posX + var8, this.posY + this.FONT_HEIGHT - 1.0F, 0.0);
               var9.addVertex(this.posX + var10, this.posY + this.FONT_HEIGHT - 1.0F, 0.0);
               var9.draw();
               GL11.glEnable(3553);
            }
