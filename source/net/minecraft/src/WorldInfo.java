...
public class WorldInfo {
   ...
   public WorldInfo(NBTTagCompound par1NBTTagCompound) {
      ...
      this.loadModInfoFromNBT(par1NBTTagCompound);
   }
   ...
   public WorldInfo(WorldInfo par1WorldInfo) {
      ...
      this.copyModInfo(par1WorldInfo);
   }
   ...
   private void updateTagCompound(NBTTagCompound par1NBTTagCompound, NBTTagCompound par2NBTTagCompound) {
      ...
      this.saveModInfoToNBT(par1NBTTagCompound);
   ...
   public InventoryEnderChest getGlobalEnderChestInventory() {
      return this.globalEnderChestInventory;
   }

   public void setGlobalEnderChestInventory(InventoryEnderChest inventory) {
      this.globalEnderChestInventory = inventory;
   }
