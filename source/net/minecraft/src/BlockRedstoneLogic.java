...
public abstract class BlockRedstoneLogic extends BlockDirectional {
   ...
   public boolean canPlaceBlockAt(World par1World, int par2, int par3, int par4) {
      return !par1World.doesBlockHaveSolidTopSurface(par2, par3 - 1, par4) ? false : super.c(par1World, par2, par3, par4);
   }

   @Override
   public boolean canBlockStay(World par1World, int par2, int par3, int par4) {
      return !par1World.doesBlockHaveSolidTopSurface(par2, par3 - 1, par4) ? false : super.f(par1World, par2, par3, par4);
   }
   ...
   public Icon getIcon(int par1, int par2) {
      return par1 == 0
         ? (this.isRepeaterPowered ? Block.torchRedstoneActive.getBlockTextureFromSide(par1) : Block.torchRedstoneIdle.getBlockTextureFromSide(par1))
         : (par1 == 1 ? this.blockIcon : Block.stoneDoubleSlab.m(1));
   }
            ...
            : (
               var7 == 1 && par5 == 4
                  ...
                  : (
                     var7 == 2 && par5 == 2
                        ? this.func_94480_d(par1IBlockAccess, par2, par3, par4, var6)
                        : (var7 == 3 && par5 == 5 ? this.func_94480_d(par1IBlockAccess, par2, par3, par4, var6) : 0)
                  )
            );
      }
   }
   ...
   protected int getInputStrength(World par1World, int par2, int par3, int par4, int par5) {
      ...
      return var9 >= 15
         ? var9
         : Math.max(var9, par1World.getBlockId(var7, par3, var8) == Block.redstoneWire.blockID ? par1World.getBlockMetadata(var7, par3, var8) : 0);
   }
   ...
   public void onBlockPlacedBy(World par1World, int par2, int par3, int par4, EntityLiving par5EntityLiving, ItemStack par6ItemStack) {
      int var7 = ((MathHelper.floor_double(par5EntityLiving.rotationYaw * 4.0F / 360.0F + 0.5) & 3) + 2) % 4;
   ...
   public void onBlockDestroyedByPlayer(World par1World, int par2, int par3, int par4, int par5) {
      ...
      super.g(par1World, par2, par3, par4, par5);
   }
   ...
   public static boolean isRedstoneRepeaterBlockID(int par0) {
      return Block.redstoneRepeaterIdle.g(par0) || Block.redstoneComparatorIdle.g(par0);
   }
