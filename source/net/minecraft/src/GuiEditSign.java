...
public class GuiEditSign extends GuiScreen {
   ...
   public void drawScreen(int var1, int var2, float var3) {
      this.e();
      this.a(this.fontRenderer, this.screenTitle, this.width / 2, 40, 16777215);
      GL11.glPushMatrix();
      GL11.glTranslatef(this.width / 2, 0.0F, 50.0F);
      float var4 = 93.75F;
      GL11.glScalef(-var4, -var4, -var4);
      GL11.glRotatef(180.0F, 0.0F, 1.0F, 0.0F);
      Block var5 = this.entitySign.q();
      if (var5 == Block.signPost) {
         float var6 = this.entitySign.p() * 360 / 16.0F;
         GL11.glRotatef(var6, 0.0F, 1.0F, 0.0F);
         GL11.glTranslatef(0.0F, -1.0625F, 0.0F);
      } else {
         int var8 = this.entitySign.p();
         float var7 = 0.0F;
         if (var8 == 2) {
            var7 = 180.0F;
         }
