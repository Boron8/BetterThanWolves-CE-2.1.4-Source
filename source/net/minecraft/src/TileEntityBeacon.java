...
public class TileEntityBeacon extends TileEntity implements IInventory {
   ...
   private void addEffectsToPlayers() {
      if (this.isBeaconActive && this.levels > 0 && !this.worldObj.isRemote && this.primaryEffect > 0) {
         ...
         AxisAlignedBB var4 = AxisAlignedBB.getAABBPool()
            .getAABB(this.xCoord, this.yCoord, this.zCoord, this.xCoord + 1, this.yCoord + 1, this.zCoord + 1)
         ...
         for (EntityPlayer var7 : var5) {
            var7.d(new PotionEffect(this.primaryEffect, 180, var3, true));
         }

         if (this.levels >= 4 && this.primaryEffect != this.secondaryEffect && this.secondaryEffect > 0) {
            for (EntityPlayer var7 : var5) {
               var7.d(new PotionEffect(this.secondaryEffect, 180, 0, true));
            }
         }
      }
   }
   ...
   public void setPrimaryEffect(int par1) {
      ...
      for (int var2 = 0; var2 < this.levels && var2 < 3; var2++) {
         for (Potion var6 : effectsList[var2]) {
            if (var6.id == par1) {
   ...
   public ItemStack decrStackSize(int par1, int par2) {
      if (par1 != 0 || this.payment == null) {
         return null;
      } else if (par2 >= this.payment.stackSize) {
   ...
   protected void setIsOn(boolean bOn) {
      this.isBeaconActive = bOn;
   }

   protected void setPrimaryBeaconEffect(int iEffect) {
      this.primaryEffect = iEffect;
   }
