...
public class ItemPotion extends Item {
      ...
      if (!par2World.isRemote) {
         ...
         if (var4 != null) {
            for (PotionEffect var6 : var4) {
               par3EntityPlayer.d(new PotionEffect(var6));
            }
         }
      }
   ...
   public void getSubItems(int par1, CreativeTabs par2CreativeTabs, List par3List) {
      ...
      for (int var5 : field_77835_b.values()) {
   ...
   public static Icon func_94589_d(String par0Str) {
      return par0Str == "potion"
         ? Item.potion.field_94590_d
         : (par0Str == "potion_splash" ? Item.potion.field_94591_c : (par0Str == "potion_contents" ? Item.potion.field_94592_ct : null));
   }
}
