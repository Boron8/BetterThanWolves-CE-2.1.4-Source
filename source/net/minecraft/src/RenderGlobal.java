...
public class RenderGlobal implements IWorldAccess {
   ...
   public RenderGlobal(Minecraft par1Minecraft, RenderEngine par2RenderEngine) {
      ...
      if (this.occlusionEnabled) {
         ...
         ((Buffer)this.glOcclusionQueryBase).limit(var3 * var3 * var4);
      ...
      for (int var9 = -var7 * var8; var9 <= var7 * var8; var9 += var7) {
         for (int var10 = -var7 * var8; var10 <= var7 * var8; var10 += var7) {
      ...
      for (int var12 = -var7 * var8; var12 <= var7 * var8; var12 += var7) {
         for (int var10 = -var7 * var8; var10 <= var7 * var8; var10 += var7) {
            var5.addVertex(var12 + var7, var6, var10 + 0);
            var5.addVertex(var12 + 0, var6, var10 + 0);
            var5.addVertex(var12 + 0, var6, var10 + var7);
            var5.addVertex(var12 + var7, var6, var10 + var7);
         }
      }
            ...
            for (int var5 = 0; var5 < this.renderChunksTall; var5++) {
               for (int var6 = 0; var6 < this.renderChunksDeep; var6++) {
                  this.worldRenderers[(var6 * this.renderChunksTall + var5) * this.renderChunksWide + var8] = new WorldRenderer(
                     this.theWorld, this.tileEntities, var8 * 16, var5 * 16, var6 * 16, this.glRenderListBase + var2
                  );
                  if (this.occlusionEnabled) {
      ...
      if (this.renderEntitiesStartupCounter > 0) {
         ...
         RenderManager.instance
            .cacheActiveRenderInfo(
               this.theWorld, this.renderEngine, this.mc.fontRenderer, this.mc.renderViewEntity, this.mc.pointedEntityLiving, this.mc.gameSettings, par3
            );
         ...
         for (int var8 = 0; var8 < var5.size(); var8++) {
            Entity var7 = (Entity)var5.get(var8);
            if (var7.isInRangeToRenderVec3D(par1Vec3)
               && (var7.ignoreFrustumCheck || par2ICamera.isBoundingBoxInFrustum(var7.getVisualBoundingBox()) || var7.riddenByEntity == this.mc.thePlayer)
               && (var7 != this.mc.renderViewEntity || this.mc.gameSettings.thirdPersonView != 0 || this.mc.renderViewEntity.isPlayerSleeping())
               && this.theWorld.f(MathHelper.floor_double(var7.posX), 0, MathHelper.floor_double(var7.posZ))) {
               this.countEntitiesRendered++;
               RenderManager.instance.renderEntity(var7, par3);
            }
         }
         ...
         for (int var9 = 0; var9 < this.tileEntities.size(); var9++) {
            TileEntityRenderer.instance.renderTileEntity((TileEntity)this.tileEntities.get(var9), par3);
         }
      ...
      if (!RenderPass.preRenderPass(RenderPassMap.map17To18(par2))) {
         ...
         if (var11 * var11 + var13 * var13 + var15 * var15 > 16.0) {
            ...
            this.markRenderersForNewPosition(
               MathHelper.floor_double(par1EntityLiving.posX), MathHelper.floor_double(par1EntityLiving.posY), MathHelper.floor_double(par1EntityLiving.posZ)
            );
   ...
   public void renderSky(float par1) {
      SkyRenderer.setup(this.theWorld, par1, this.theWorld.c(par1));
      if (this.mc.theWorld.provider.dimensionId == 1) {
         ...
         GL11.glDisable(3553);
         Vec3 var2 = this.theWorld.a(this.mc.renderViewEntity, par1);
         ...
         GL11.glBlendFunc(770, 771);
         RenderHelper.disableStandardItemLighting();
         float[] var24 = this.theWorld.provider.calcSunriseSunsetColors(this.theWorld.c(par1), par1);
         if (var24 != null) {
            GL11.glDisable(3553);
            GL11.glShadeModel(7425);
            GL11.glPushMatrix();
            GL11.glRotatef(90.0F, 1.0F, 0.0F, 0.0F);
            GL11.glRotatef(MathHelper.sin(this.theWorld.d(par1)) < 0.0F ? 180.0F : 0.0F, 0.0F, 0.0F, 1.0F);
            GL11.glRotatef(90.0F, 0.0F, 0.0F, 1.0F);
            float var8 = var24[0];
            float var9 = var24[1];
            float var10 = var24[2];
         ...
         GL11.glPushMatrix();
         float var8 = 1.0F - this.theWorld.i(par1);
         float var9 = 0.0F;
         float var10 = 0.0F;
         float var11 = 0.0F;
         ...
         GL11.glRotatef(this.theWorld.c(par1) * 360.0F, 1.0F, 0.0F, 0.0F);
         float var12 = 30.0F;
         ...
         var23.addVertexWithUV(-var12, 100.0, -var12, 0.0, 0.0);
         var23.addVertexWithUV(var12, 100.0, -var12, 1.0, 0.0);
         var23.addVertexWithUV(var12, 100.0, var12, 1.0, 1.0);
         var23.addVertexWithUV(-var12, 100.0, var12, 0.0, 1.0);
         var23.draw();
         var12 = 20.0F;
         int var28 = this.theWorld.w();
         if (CompanionBeaconEffect.companionStrength > 0) {
            this.renderEngine
               .bindTexture(FakeResourceLocation.unwrap(SkyRenderer.setupCelestialObject(FakeResourceLocation.wrap("/environment/moon_moon_phases.png"))));
         } else {
            this.renderEngine
               .bindTexture(FakeResourceLocation.unwrap(SkyRenderer.setupCelestialObject(FakeResourceLocation.wrap("/environment/moon_phases.png"))));
         }
         ...
         var23.startDrawingQuads();
         var23.addVertexWithUV(-var12, -100.0, var12, var18, var19);
         var23.addVertexWithUV(var12, -100.0, var12, var16, var19);
         var23.addVertexWithUV(var12, -100.0, -var12, var16, var17);
         var23.addVertexWithUV(-var12, -100.0, -var12, var18, var17);
         var23.draw();
         GL11.glDisable(3553);
         float var20 = this.theWorld.g(par1) * var8;
         ...
         double var25 = this.mc.thePlayer.h(par1).yCoord - this.theWorld.T();
         if (var25 < 0.0) {
            GL11.glPushMatrix();
   ...
   public void renderClouds(float par1) {
      if (this.mc.theWorld.provider.isSurfaceWorld()) {
         if (ColorizeWorld.drawFancyClouds(this.mc.gameSettings.fancyGraphics)) {
            ...
            GL11.glDisable(2884);
            float var2 = (float)(this.mc.renderViewEntity.lastTickPosY + (this.mc.renderViewEntity.posY - this.mc.renderViewEntity.lastTickPosY) * par1);
            byte var3 = 32;
            int var4 = 256 / var3;
            Tessellator var5 = Tessellator.instance;
            ...
            GL11.glEnable(3042);
            GL11.glBlendFunc(770, 771);
            Vec3 var6 = this.theWorld.e(par1);
            ...
            double var24 = this.cloudTickCounter + par1;
            double var13 = this.mc.renderViewEntity.prevPosX + (this.mc.renderViewEntity.posX - this.mc.renderViewEntity.prevPosX) * par1 + var24 * 0.03F;
            double var15 = this.mc.renderViewEntity.prevPosZ + (this.mc.renderViewEntity.posZ - this.mc.renderViewEntity.prevPosZ) * par1;
   ...
   public void renderCloudsFancy(float par1) {
      ...
      float var4 = 12.0F;
      float var5 = 4.0F;
      double var6 = this.cloudTickCounter + par1;
      double var8 = (this.mc.renderViewEntity.prevPosX + (this.mc.renderViewEntity.posX - this.mc.renderViewEntity.prevPosX) * par1 + var6 * 0.03F) / var4;
      double var10 = (this.mc.renderViewEntity.prevPosZ + (this.mc.renderViewEntity.posZ - this.mc.renderViewEntity.prevPosZ) * par1) / var4 + 0.33F;
      ...
      GL11.glEnable(3042);
      GL11.glBlendFunc(770, 771);
      Vec3 var15 = this.theWorld.e(par1);
      ...
      float var19 = (float)(var8 * 0.0);
      float var20 = (float)(var10 * 0.0);
         ...
         for (int var28 = -var25 + 1; var28 <= var25; var28++) {
            for (int var29 = -var25 + 1; var29 <= var25; var29++) {
               ...
               if (var28 > -1) {
                  ...
                  for (int var34 = 0; var34 < var24; var34++) {
                     var3.addVertexWithUV(
                        var32 + var34 + 0.0F, var12 + 0.0F, var33 + var24, (var30 + var34 + 0.5F) * var21 + var19, (var31 + var24) * var21 + var20
                     );
                     var3.addVertexWithUV(
                        var32 + var34 + 0.0F, var12 + var5, var33 + var24, (var30 + var34 + 0.5F) * var21 + var19, (var31 + var24) * var21 + var20
                     );
                     var3.addVertexWithUV(
                        var32 + var34 + 0.0F, var12 + var5, var33 + 0.0F, (var30 + var34 + 0.5F) * var21 + var19, (var31 + 0.0F) * var21 + var20
                     );
                     var3.addVertexWithUV(
                        var32 + var34 + 0.0F, var12 + 0.0F, var33 + 0.0F, (var30 + var34 + 0.5F) * var21 + var19, (var31 + 0.0F) * var21 + var20
                     );
                  }
               }
               ...
               if (var28 <= 1) {
                  ...
                  for (int var34 = 0; var34 < var24; var34++) {
                     var3.addVertexWithUV(
                        var32 + var34 + 1.0F - var26, var12 + 0.0F, var33 + var24, (var30 + var34 + 0.5F) * var21 + var19, (var31 + var24) * var21 + var20
                     );
                     var3.addVertexWithUV(
                        var32 + var34 + 1.0F - var26, var12 + var5, var33 + var24, (var30 + var34 + 0.5F) * var21 + var19, (var31 + var24) * var21 + var20
                     );
                     var3.addVertexWithUV(
                        var32 + var34 + 1.0F - var26, var12 + var5, var33 + 0.0F, (var30 + var34 + 0.5F) * var21 + var19, (var31 + 0.0F) * var21 + var20
                     );
                     var3.addVertexWithUV(
                        var32 + var34 + 1.0F - var26, var12 + 0.0F, var33 + 0.0F, (var30 + var34 + 0.5F) * var21 + var19, (var31 + 0.0F) * var21 + var20
                     );
                  }
               }
               ...
               if (var29 > -1) {
                  ...
                  for (int var34 = 0; var34 < var24; var34++) {
                     var3.addVertexWithUV(
                        var32 + 0.0F, var12 + var5, var33 + var34 + 0.0F, (var30 + 0.0F) * var21 + var19, (var31 + var34 + 0.5F) * var21 + var20
                     );
                     var3.addVertexWithUV(
                        var32 + var24, var12 + var5, var33 + var34 + 0.0F, (var30 + var24) * var21 + var19, (var31 + var34 + 0.5F) * var21 + var20
                     );
                     var3.addVertexWithUV(
                        var32 + var24, var12 + 0.0F, var33 + var34 + 0.0F, (var30 + var24) * var21 + var19, (var31 + var34 + 0.5F) * var21 + var20
                     );
                     var3.addVertexWithUV(
                        var32 + 0.0F, var12 + 0.0F, var33 + var34 + 0.0F, (var30 + 0.0F) * var21 + var19, (var31 + var34 + 0.5F) * var21 + var20
                     );
                  }
               }
               ...
               if (var29 <= 1) {
                  ...
                  for (int var34 = 0; var34 < var24; var34++) {
                     var3.addVertexWithUV(
                        var32 + 0.0F, var12 + var5, var33 + var34 + 1.0F - var26, (var30 + 0.0F) * var21 + var19, (var31 + var34 + 0.5F) * var21 + var20
                     );
                     var3.addVertexWithUV(
                        var32 + var24, var12 + var5, var33 + var34 + 1.0F - var26, (var30 + var24) * var21 + var19, (var31 + var34 + 0.5F) * var21 + var20
                     );
                     var3.addVertexWithUV(
                        var32 + var24, var12 + 0.0F, var33 + var34 + 1.0F - var26, (var30 + var24) * var21 + var19, (var31 + var34 + 0.5F) * var21 + var20
                     );
                     var3.addVertexWithUV(
                        var32 + 0.0F, var12 + 0.0F, var33 + var34 + 1.0F - var26, (var30 + 0.0F) * var21 + var19, (var31 + var34 + 0.5F) * var21 + var20
                     );
                  }
               }
   ...
   public boolean updateRenderers(EntityLiving par1EntityLiving, boolean par2) {
      ...
      for (int var9 = 0; var9 < var7; var9++) {
         WorldRenderer var10 = (WorldRenderer)this.worldRenderersToUpdate.get(var9);
         if (var10 != null) {
            if (!par2) {
               if (var10.distanceToEntitySquared(par1EntityLiving) > 256.0F) {
                  int var11 = 0;

                  while (var11 < var3 && (var5[var11] == null || var4.doCompare(var5[var11], var10) <= 0)) {
                     var11++;
                  }
      ...
      if (var6 != null) {
         ...
         for (int var17 = var6.size() - 1; var17 >= 0; var17--) {
            WorldRenderer var10 = (WorldRenderer)var6.get(var17);
      ...
      for (int var12 = this.worldRenderersToUpdate.size(); var23 != var12; var23++) {
         WorldRenderer var13 = (WorldRenderer)this.worldRenderersToUpdate.get(var23);
         if (var13 != null) {
            boolean var14 = false;
      ...
      while (--var23 >= var11) {
         this.worldRenderersToUpdate.remove(var23);
      }

      this.theWorld.theProfiler.endSection();
      return var7 == var8 + var18;
   }
      ...
      if (!this.damagedBlocks.isEmpty()) {
         ...
         while (var10.hasNext()) {
            ...
            if (var12 * var12 + var14 * var14 + var16 * var16 > 1024.0) {
               ...
               int var18 = this.theWorld.a(var11.getPartialBlockX(), var11.getPartialBlockY(), var11.getPartialBlockZ());
               Block var19 = var18 > 0 ? Block.blocksList[var18] : null;
               if (var19 == null) {
                  var19 = Block.stone;
               }

               var19.renderBlockWithTexture(
                  this.globalRenderBlocks,
                  var11.getPartialBlockX(),
                  var11.getPartialBlockY(),
   ...
   public void drawSelectionBox(EntityPlayer par1EntityPlayer, MovingObjectPosition par2MovingObjectPosition, int par3, ItemStack par4ItemStack, float par5) {
      if (par3 == 0 && par2MovingObjectPosition.typeOfHit == EnumMovingObjectType.TILE) {
         ...
         GL11.glDepthMask(false);
         float var6 = 0.002F;
         int var7 = this.theWorld.a(par2MovingObjectPosition.blockX, par2MovingObjectPosition.blockY, par2MovingObjectPosition.blockZ);
         if (var7 > 0) {
            ...
            this.drawOutlinedBoundingBox(
               Block.blocksList[var7]
                  .getSelectedBoundingBoxFromPool(this.theWorld, par2MovingObjectPosition)
      ...
      if (this.mc != null && this.mc.renderViewEntity != null && this.mc.effectRenderer != null) {
         ...
         if (par1Str.equals("hugeexplosion")) {
            this.mc
               .effectRenderer
               .addEffect(
                  (EntityFX)(var21 = (EntityFX)EntityList.createEntityOfType(EntityHugeExplodeFX.class, this.theWorld, par2, par4, par6, par8, par10, par12))
               );
            ...
            this.mc
               ...
               .addEffect(
                  (EntityFX)(
                     var21 = (EntityFX)EntityList.createEntityOfType(
                        EntityLargeExplodeFX.class, this.renderEngine, this.theWorld, par2, par4, par6, par8, par10, par12
                     )
                  )
               );
            ...
            this.mc
               ...
               .addEffect(
                  (EntityFX)(
                     var21 = (EntityFX)EntityList.createEntityOfType(
                        EntityFireworkSparkFX.class, this.theWorld, par2, par4, par6, par8, par10, par12, this.mc.effectRenderer
                     )
                  )
               );
         } else if (par1Str.equals("fccinders")) {
            double dDistSqToPlayer = var15 * var15 + var17 * var17 + var19 * var19;
            if (dDistSqToPlayer < 1024.0) {
         ...
         if (var21 != null) {
            ...
            if (var15 * var15 + var17 * var17 + var19 * var19 > var22 * var22) {
               ...
               if (par1Str.equals("bubble")) {
                  ...
                  var21 = EntityList.createEntityOfType(EntityCritFX.class, this.theWorld, par2, par4, par6, par8, par10, par12);
                  ((EntityFX)var21)
                     .setRBGColorF(((EntityFX)var21).getRedColorF() * 0.3F, ((EntityFX)var21).getGreenColorF() * 0.8F, ((EntityFX)var21).getBlueColorF());
                  ...
                  var21 = EntityList.createEntityOfType(EntitySpellParticleFX.class, this.theWorld, par2, par4, par6, 0.0, 0.0, 0.0);
                  ...
                  var21 = EntityList.createEntityOfType(EntityHeartFX.class, this.theWorld, par2, par4 + 0.5, par6, par8, par10, par12);
                  ...
                  var21 = EntityList.createEntityOfType(
                     EntityBreakingFX.class, this.theWorld, par2, par4, par6, par8, par10, par12, Item.itemsList[var27], this.renderEngine
                  );
               } else if (par1Str.startsWith("tilecrack_")) {
                  String[] var28 = par1Str.split("_", 3);
                  int var25 = Integer.parseInt(var28[1]);
                  int var26 = Integer.parseInt(var28[2]);
                  var21 = ((EntityDiggingFX)EntityList.createEntityOfType(
                        EntityDiggingFX.class, this.theWorld, par2, par4, par6, par8, par10, par12, Block.blocksList[var25], 0, var26, this.renderEngine
                     ))
                     .applyRenderColor(var26);
               } else if (par1Str.equals("fcwhitesmoke")) {
                  var21 = EntityList.createEntityOfType(WhiteSmokeFX.class, this.theWorld, par2, par4, par6, par8, par10, par12);
               } else if (par1Str.equals("fcwhitecloud")) {
                  var21 = EntityList.createEntityOfType(WhiteCloudFX.class, this.theWorld, par2, par4, par6, par8, par10, par12);
               } else if (par1Str.equals("fcsmallflame")) {
                  var21 = EntityList.createEntityOfType(SmallFlameFX.class, this.theWorld, par2, par4, par6, par8, par10, par12);
               } else if (par1Str.equals("dripBlood")) {
                  var21 = EntityList.createEntityOfType(
                     EntityDropParticleFX.class, this.theWorld, par2, par4, par6, BTWBlocks.bloodMaterial, 5, 0.8F, 0.0F, 0.0F, 1.0F
                  );
               } else {
      ...
      switch (par1) {
         ...
         case 1018:
            if (this.mc.renderViewEntity != null) {
               double var7 = par2 - this.mc.renderViewEntity.posX;
               double var9 = par3 - this.mc.renderViewEntity.posY;
               double var11 = par4 - this.mc.renderViewEntity.posZ;
         ...
         default:
            AddonHandler.clientPlayCustomAuxFX(this.mc, this.theWorld, null, par1, par2, par3, par4, par5);
      }
   }
      ...
      switch (par2) {
         ...
         case 1005:
            if (Item.itemsList[par6] instanceof ItemRecord) {
               this.theWorld.a(((ItemRecord)Item.itemsList[par6]).recordName, par3, par4, par5);
            } else {
               this.theWorld.a((String)null, par3, par4, par5);
            }
            break;
         case 1007:
         ...
         case 1008:
            this.theWorld
               .playSound(par3 + 0.5, par4 + 0.5, par5 + 0.5, "mob.ghast.fireball", 10.0F, (var7.nextFloat() - var7.nextFloat()) * 0.2F + 1.0F, false);
            break;
         case 1009:
         ...
         case 1012:
            this.theWorld
               .playSound(par3 + 0.5, par4 + 0.5, par5 + 0.5, "mob.zombie.woodbreak", 2.0F, (var7.nextFloat() - var7.nextFloat()) * 0.2F + 1.0F, false);
            break;
         case 1014:
         ...
         case 1016:
            ...
            this.theWorld.playSound(par3 + 0.5, par4 + 0.5, par5 + 0.5, "mob.zombie.say", 1.0F + var7.nextFloat(), var7.nextFloat() * 0.2F + 0.5F, false);
            break;
         case 1017:
         ...
         case 2000:
            int var33 = par6 % 3 - 1;
            int var9 = par6 / 3 % 3 - 1;
            double var10 = par3 + var33 * 0.6 + 0.5;
            double var12 = par4 + 0.5;
            double var34 = par5 + var9 * 0.6 + 0.5;

            for (int var35 = 0; var35 < 10; var35++) {
               double var37 = var7.nextDouble() * 0.2 + 0.01;
               double var38 = var10 + var33 * 0.01 + (var7.nextDouble() - 0.5) * var9 * 0.5;
               double var39 = var12 + (var7.nextDouble() - 0.5) * 0.5;
               double var23 = var34 + var9 * 0.01 + (var7.nextDouble() - 0.5) * var33 * 0.5;
               double var25 = var33 * var37 + var7.nextGaussian() * 0.01;
               double var27 = -0.03 + var7.nextGaussian() * 0.01;
               double var29 = var9 * var37 + var7.nextGaussian() * 0.01;
            ...
            if (var20 > 0) {
               ...
               this.mc
                  ...
                  .playSound(
                     ...
                     par4 + 0.5F,
                     par5 + 0.5F,
                     (stepSound.getBreakVolume() + 1.0F) / 2.0F,
                     stepSound.getBreakPitch() * 0.8F
                  );
            }

            this.mc.effectRenderer.addBlockDestroyEffects(par3, par4, par5, par6 & 4095, par6 >> 12 & 0xFF);
            break;
         case 2002:
            double var8 = par3;
            double var10 = par4;
            ...
            int var49 = Item.potion.getColorFromDamage(par6);
            float var16 = (var49 >> 16 & 0xFF) / 255.0F;
            float var17 = (var49 >> 8 & 0xFF) / 255.0F;
            float var18 = (var49 >> 0 & 0xFF) / 255.0F;
            String var19 = "spell";
            ...
            for (int var20 = 0; var20 < 100; var20++) {
               ...
               EntityFX var31 = this.doSpawnParticle(var19, var8 + var25 * 0.1, var10 + 0.3, var12 + var29 * 0.1, var25, var27, var29);
               if (var31 != null) {
            ...
            break;
         case 2003:
            double var8 = par3 + 0.5;
            double var10 = par4;
            double var12 = par5 + 0.5;
            String var14 = "iconcrack_" + Item.eyeOfEnder.itemID;
            ...
            for (double var36 = 0.0; var36 < Math.PI * 2; var36 += Math.PI / 20) {
               this.spawnParticle(
                  "portal", var8 + Math.cos(var36) * 5.0, var10 - 0.4, var12 + Math.sin(var36) * 5.0, Math.cos(var36) * -5.0, 0.0, Math.sin(var36) * -5.0
               );
               this.spawnParticle(
                  "portal", var8 + Math.cos(var36) * 5.0, var10 - 0.4, var12 + Math.sin(var36) * 5.0, Math.cos(var36) * -7.0, 0.0, Math.sin(var36) * -7.0
               );
            }
         ...
         case 2004:
            for (int var21 = 0; var21 < 20; var21++) {
               double var22 = par3 + 0.5 + (this.theWorld.rand.nextFloat() - 0.5) * 2.0;
               double var24 = par4 + 0.5 + (this.theWorld.rand.nextFloat() - 0.5) * 2.0;
               double var26 = par5 + 0.5 + (this.theWorld.rand.nextFloat() - 0.5) * 2.0;
               this.theWorld.a("smoke", var22, var24, var26, 0.0, 0.0, 0.0);
               this.theWorld.a("flame", var22, var24, var26, 0.0, 0.0, 0.0);
            }
         ...
         default:
            AddonHandler.clientPlayCustomAuxFX(this.mc, this.theWorld, par1EntityPlayer, par2, par3, par4, par5, par6);
      }
   }
   ...
   public void destroyBlockPartially(int par1, int par2, int par3, int par4, int par5) {
      if (par5 >= 0 && par5 < 10) {
         DestroyBlockProgress var6 = (DestroyBlockProgress)this.damagedBlocks.get(par1);
   ...
   public Icon getDestroyedBlockIcon(int iBlockDamage) {
      ...
      return this.destroyBlockIcons[iBlockDamage];
   }
}
