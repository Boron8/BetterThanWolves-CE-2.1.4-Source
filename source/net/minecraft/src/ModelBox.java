...
public class ModelBox {
   ...
   public ModelBox(ModelRenderer var1, int var2, int var3, float var4, float var5, float var6, int var7, int var8, int var9, float var10) {
      ...
      this.quadList[1] = new TexturedQuad(
         new PositionTextureVertex[]{var29, var18, var21, var17}, var2, var3 + var9, var2 + var9, var3 + var9 + var8, var1.textureWidth, var1.textureHeight
      );
      this.quadList[2] = new TexturedQuad(
         new PositionTextureVertex[]{var19, var18, var29, var15}, var2 + var9, var3, var2 + var9 + var7, var3 + var9, var1.textureWidth, var1.textureHeight
      );
