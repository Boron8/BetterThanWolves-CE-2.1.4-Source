...
public class AxisAlignedBB extends PrimitiveGeometric {
   ...
   public double calculateXOffset(AxisAlignedBB par1AxisAlignedBB, double par2) {
      if (!(par1AxisAlignedBB.maxY > this.minY) || !(par1AxisAlignedBB.minY < this.maxY)) {
         return par2;
      } else if (par1AxisAlignedBB.maxZ > this.minZ && par1AxisAlignedBB.minZ < this.maxZ) {
   ...
   public double calculateZOffset(AxisAlignedBB par1AxisAlignedBB, double par2) {
      if (!(par1AxisAlignedBB.maxX > this.minX) || !(par1AxisAlignedBB.minX < this.maxX)) {
         return par2;
      } else if (par1AxisAlignedBB.maxY > this.minY && par1AxisAlignedBB.minY < this.maxY) {
   ...
   public boolean isVecInside(Vec3 par1Vec3) {
      return !(par1Vec3.xCoord > this.minX) || !(par1Vec3.xCoord < this.maxX)
         ? false
         : (par1Vec3.yCoord > this.minY && par1Vec3.yCoord < this.maxY ? par1Vec3.zCoord > this.minZ && par1Vec3.zCoord < this.maxZ : false);
   }
   ...
   private boolean isVecInYZ(Vec3 par1Vec3) {
      return par1Vec3 == null
         ? false
         : par1Vec3.yCoord >= this.minY && par1Vec3.yCoord <= this.maxY && par1Vec3.zCoord >= this.minZ && par1Vec3.zCoord <= this.maxZ;
   }

   private boolean isVecInXZ(Vec3 par1Vec3) {
      return par1Vec3 == null
         ? false
         : par1Vec3.xCoord >= this.minX && par1Vec3.xCoord <= this.maxX && par1Vec3.zCoord >= this.minZ && par1Vec3.zCoord <= this.maxZ;
   }

   private boolean isVecInXY(Vec3 par1Vec3) {
      return par1Vec3 == null
         ? false
         : par1Vec3.xCoord >= this.minX && par1Vec3.xCoord <= this.maxX && par1Vec3.yCoord >= this.minY && par1Vec3.yCoord <= this.maxY;
   }
   ...
   public void rotateAroundYToFacing(int iFacing) {
      if (iFacing > 2) {
         if (iFacing == 5) {
            this.setBounds(1.0 - this.maxZ, this.minY, 1.0 - this.maxX, 1.0 - this.minZ, this.maxY, 1.0 - this.minX);
         } else if (iFacing == 4) {
            this.setBounds(this.minZ, this.minY, this.minX, this.maxZ, this.maxY, this.maxX);
         } else {
            this.setBounds(1.0 - this.maxX, this.minY, 1.0 - this.maxZ, 1.0 - this.minX, this.maxY, 1.0 - this.minZ);
         }
      }
   }
   ...
   public void tiltToFacingAlongY(int iFacing) {
      if (iFacing == 0) {
         this.setBounds(1.0 - this.maxX, 1.0 - this.maxY, this.minZ, 1.0 - this.minX, 1.0 - this.minY, this.maxZ);
      } else if (iFacing == 2) {
         this.setBounds(this.minX, this.minZ, 1.0 - this.maxY, this.maxX, this.maxZ, 1.0 - this.minY);
      } else if (iFacing == 3) {
         this.setBounds(this.minX, 1.0 - this.maxZ, this.minY, this.maxX, 1.0 - this.minZ, this.maxY);
      } else if (iFacing == 4) {
         this.setBounds(1.0 - this.maxY, this.minX, this.minZ, 1.0 - this.minY, this.maxX, this.maxZ);
      } else if (iFacing == 5) {
         this.setBounds(this.minY, 1.0 - this.maxX, this.minZ, this.maxY, 1.0 - this.minX, this.maxZ);
      }
   }

   @Override
   public void translate(double dDeltaX, double dDeltaY, double dDeltaZ) {
      this.offset(dDeltaX, dDeltaY, dDeltaZ);
   }

   @Override
   public void addToRayTrace(RayTraceUtils rayTrace) {
      rayTrace.addBoxWithLocalCoordsToIntersectionList(this.minX, this.minY, this.minZ, this.maxX, this.maxY, this.maxZ);
   }
   ...
   public void addIntersectingBoxesToCollisionList(World world, int i, int j, int k, AxisAlignedBB boxToIntersect, List collisionList) {
      AxisAlignedBB offsetBox = this.makeTemporaryCopy().offset(i, j, k);
