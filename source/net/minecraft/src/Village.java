...
public class Village {
      ...
      List var1 = this.worldObj
         .getEntitiesWithinAABB(
            ...
            AxisAlignedBB.getAABBPool()
               .getAABB(
                  this.center.posX - this.villageRadius,
                  this.center.posY - 4,
   ...
   public void addVillageDoorInfo(VillageDoorInfo par1VillageDoorInfo) {
      ...
      this.centerHelper.posX = this.centerHelper.posX + par1VillageDoorInfo.posX;
      this.centerHelper.posY = this.centerHelper.posY + par1VillageDoorInfo.posY;
      this.centerHelper.posZ = this.centerHelper.posZ + par1VillageDoorInfo.posZ;
   ...
   public void addOrRenewAgressor(EntityLiving par1EntityLiving) {
      for (VillageAgressor var3 : this.villageAgressors) {
   ...
   public EntityLiving findNearestVillageAggressor(EntityLiving par1EntityLiving) {
      ...
      for (int var5 = 0; var5 < this.villageAgressors.size(); var5++) {
         ...
         double var7 = var6.agressor.e(par1EntityLiving);
         if (var7 <= var2) {
            var4 = var6;
            var2 = var7;
         }
   ...
   private void removeDeadAndOutOfRangeDoors() {
      ...
      while (var3.hasNext()) {
         ...
         if (this.worldObj.chunkExists(var4.posX >> 4, var4.posZ >> 4)
            && (!this.isBlockDoor(var4.posX, var4.posY, var4.posZ) || Math.abs(this.tickCounter - var4.lastActivityTimestamp) > 1200)) {
            this.centerHelper.posX = this.centerHelper.posX - var4.posX;
            this.centerHelper.posY = this.centerHelper.posY - var4.posY;
            this.centerHelper.posZ = this.centerHelper.posZ - var4.posZ;
            var1 = true;
   ...
   public void readVillageDataFromNBT(NBTTagCompound par1NBTTagCompound) {
      ...
      for (int var3 = 0; var3 < var2.tagCount(); var3++) {
         ...
         VillageDoorInfo var5 = new VillageDoorInfo(
            var4.getInteger("X"), var4.getInteger("Y"), var4.getInteger("Z"), var4.getInteger("IDX"), var4.getInteger("IDZ"), var4.getInteger("TS")
         );
