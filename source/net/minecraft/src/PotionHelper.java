...
public class PotionHelper {
   ...
   public static boolean func_82817_b(Collection par0Collection) {
      for (PotionEffect var2 : par0Collection) {
   ...
   private static int parsePotionEffects(String par0Str, int par1, int par2, int par3) {
      if (par1 < par0Str.length() && par2 >= 0 && par1 < par2) {
         ...
         if (var4 >= 0 && var4 < par2) {
            int var5 = parsePotionEffects(par0Str, par1, var4 - 1, par3);
            if (var5 > 0) {
               return var5;
            } else {
               int var17 = parsePotionEffects(par0Str, var4 + 1, par2, par3);
               return var17 > 0 ? var17 : 0;
            }
         } else {
            int var5 = par0Str.indexOf(38, par1);
            if (var5 >= 0 && var5 < par2) {
               int var17 = parsePotionEffects(par0Str, par1, var5 - 1, par3);
               if (var17 <= 0) {
                  return 0;
               } else {
   ...
   public static List getPotionEffects(int par0, boolean par1) {
      ...
      for (Potion var6 : Potion.potionTypes) {
         if (var6 != null && (!var6.isUsable() || par1)) {
            String var7 = (String)potionRequirements.get(var6.getId());
            if (var7 != null) {
