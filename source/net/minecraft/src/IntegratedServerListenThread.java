...
public class IntegratedServerListenThread extends NetworkListenThread {
   ...
   public IntegratedServerListenThread(IntegratedServer var1) {
      super(var1);
      this.netMemoryConnection = new MemoryConnection(var1.getLogAgent(), null);
   }
   ...
   public void networkTick() {
      if (this.theMemoryConnection != null) {
         EntityPlayerMP var1 = this.getIntegratedServer().ad().createPlayerForUser(this.field_71759_e);
         if (var1 != null) {
            this.netMemoryConnection.pairWith(this.theMemoryConnection);
            this.field_71756_f = true;
            this.getIntegratedServer().ad().initializeConnectionToPlayer(this.netMemoryConnection, var1);
         }
   ...
   public boolean isGamePaused() {
      return this.field_71756_f
         && this.netMemoryConnection.getPairedConnection().isConnectionActive()
         && this.netMemoryConnection.getPairedConnection().isGamePaused();
   }
}
