...
public class ItemFood extends Item {
   ...
   protected void onFoodEaten(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer) {
      if (!par2World.isRemote && this.potionId > 0 && par2World.rand.nextFloat() < this.potionEffectProbability) {
         par3EntityPlayer.d(new PotionEffect(this.potionId, this.potionDuration * 20, this.potionAmplifier));
      }
   }
   ...
   public ItemFood(int iItemID, int iHealAmount, float fSaturationModifier, boolean bWolfsFavoriteMeat, boolean bZombiesConsume) {
      ...
      this.doZombiesConsume = bZombiesConsume;
   }

   @Override
   public boolean doZombiesConsume() {
      return this.doZombiesConsume;
   }
