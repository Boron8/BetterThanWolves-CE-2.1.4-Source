...
public class GuiTextField extends Gui {
   ...
   public void drawTextBox() {
      if (this.getVisible()) {
         ...
         if (var4.length() > 0 && var5 && var2 < var4.length()) {
            var9 = this.fontRenderer.drawStringWithShadow(var4.substring(var2), var9, var8, var1);
         }
   ...
   private void drawCursorVertical(int var1, int var2, int var3, int var4) {
      ...
      var7.addVertex(var1, var4, 0.0);
      var7.addVertex(var3, var4, 0.0);
      var7.addVertex(var3, var2, 0.0);
      var7.addVertex(var1, var2, 0.0);
      var7.draw();
      GL11.glDisable(3058);
      GL11.glEnable(3553);
   }
   ...
   public void setSelectionPos(int var1) {
      ...
      if (this.fontRenderer != null) {
         ...
         if (var1 == this.lineScrollOffset) {
            this.lineScrollOffset = this.lineScrollOffset - this.fontRenderer.trimStringToWidth(this.text, var3, true).length();
         }

         if (var1 > var5) {
            this.lineScrollOffset += var1 - var5;
         } else if (var1 <= this.lineScrollOffset) {
            this.lineScrollOffset = this.lineScrollOffset - (this.lineScrollOffset - var1);
         }
