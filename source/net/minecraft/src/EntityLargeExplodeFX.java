...
public class EntityLargeExplodeFX extends EntityFX {
   ...
   public void renderParticle(Tessellator var1, float var2, float var3, float var4, float var5, float var6, float var7) {
      int var8 = (int)((this.field_70581_a + var2) * 15.0F / this.field_70584_aq);
      if (var8 <= 15) {
         ...
         float var14 = (float)(this.prevPosX + (this.posX - this.prevPosX) * var2 - ay);
         float var15 = (float)(this.prevPosY + (this.posY - this.prevPosY) * var2 - az);
         float var16 = (float)(this.prevPosZ + (this.posZ - this.prevPosZ) * var2 - aA);
