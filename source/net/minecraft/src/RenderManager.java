...
public class RenderManager {
   ...
   public void cacheActiveRenderInfo(
      ...
      if (par4EntityLiving.isPlayerSleeping()) {
         int var8 = par1World.getBlockId(
            MathHelper.floor_double(par4EntityLiving.posX), MathHelper.floor_double(par4EntityLiving.posY), MathHelper.floor_double(par4EntityLiving.posZ)
         );
         if (Block.blocksList[var8] instanceof BedBlockBase) {
            int var9 = par1World.getBlockMetadata(
               MathHelper.floor_double(par4EntityLiving.posX), MathHelper.floor_double(par4EntityLiving.posY), MathHelper.floor_double(par4EntityLiving.posZ)
            );
            int var10 = var9 & 3;
