...
public abstract class GuiContainer extends GuiScreen {
   ...
   public void drawScreen(int par1, int par2, float par3) {
      ...
      for (int var13 = 0; var13 < this.inventorySlots.inventorySlots.size(); var13++) {
         ...
         if (this.isMouseOverSlot(var14, par1, par2)) {
            ...
            int var9 = var14.yDisplayPosition;
      ...
      if (var16 != null) {
         byte var18 = 8;
         int var9 = this.draggedStack == null ? 8 : 16;
         String var10 = null;
      ...
      if (this.returningStack != null) {
         ...
         int var9 = this.returningStackDestSlot.xDisplayPosition - this.field_85049_r;
         int var20 = this.returningStackDestSlot.yDisplayPosition - this.field_85048_s;
         int var11 = this.field_85049_r + (int)(var9 * var17);
         int var12 = this.field_85048_s + (int)(var20 * var17);
   ...
   private void drawSlotInventory(Slot par1Slot) {
      ...
      if (!var6) {
         ...
         GL11.glEnable(2929);
         if (!this.drawSlotSpecialItems(par1Slot, var4)) {
   ...
   private void func_94066_g() {
      ...
      if (var1 != null && this.field_94076_q) {
         ...
         for (Slot var3 : this.field_94077_p) {
            ...
            this.field_94069_F = this.field_94069_F - (var4.stackSize - var5);
         }
      }
   }
   ...
   protected void func_85041_a(int par1, int par2, int par3, long par4) {
      ...
      if (this.clickedSlot != null && this.mc.gameSettings.touchscreen) {
         ...
         && var6 != null
         && var7 != null
         && var7.stackSize > this.field_94077_p.size()
         && Container.func_94527_a(var6, var7, true)
         && var6.isItemValid(var7)
         && this.inventorySlots.func_94531_b(var6)) {
      ...
      if (this.field_94074_J && var4 != null && par3 == 0 && this.inventorySlots.func_94530_a((ItemStack)null, var4)) {
         if (p()) {
            if (var4 != null && var4.inventory != null && this.field_94075_K != null) {
               for (Slot var10 : this.inventorySlots.inventorySlots) {
                  if (var10 != null
                     && var10.canTakeStack(this.mc.thePlayer)
                     && var10.getHasStack()
                     && var10.inventory == var4.inventory
                     && Container.func_94527_a(var10, this.field_94075_K, true)) {
         ...
         if (this.clickedSlot != null && this.mc.gameSettings.touchscreen) {
            if (par3 == 0 || par3 == 1) {
               ...
               boolean var9 = Container.func_94527_a(var4, this.draggedStack, false);
            ...
            for (Slot var10x : this.field_94077_p) {
               this.handleMouseClick(var10x, var10x.slotNumber, Container.func_94534_d(1, this.field_94071_C), 5);
            }
   ...
   protected void keyTyped(char par1, int par2) {
      ...
      if (this.theSlot != null && this.theSlot.getHasStack()) {
         if (par2 == this.mc.gameSettings.keyBindPickBlock.keyCode) {
            ...
            this.handleMouseClick(this.theSlot, this.theSlot.slotNumber, o() ? 1 : 0, 4);
         }
      }
   }
   ...
   public void updateScreen() {
      super.updateScreen();
      if (!this.mc.thePlayer.R() || this.mc.thePlayer.isDead) {
         this.mc.thePlayer.closeScreen();
      }
   }
      ...
      if (stack != null) {
         ...
         if (!this.isPlayerInventorySlot(slot)) {
            if (iItemID == Item.pocketSundial.itemID) {
               ...
               itemRenderer.renderItemAndEffectIntoGUI(this.fontRenderer, this.mc.renderEngine, stack, slot.xDisplayPosition, slot.yDisplayPosition);
               TextureClock.clockTexture.updateAnimation();
               return true;
            }
         } else if (iItemID == Item.compass.itemID) {
   ...
   private boolean isPlayerInventorySlot(Slot slot) {
      return this.mc.thePlayer.inventory == slot.inventory;
   }
