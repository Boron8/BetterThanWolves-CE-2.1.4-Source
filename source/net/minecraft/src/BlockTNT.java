...
public class BlockTNT extends Block {
   ...
   public void onBlockDestroyedByExplosion(World par1World, int par2, int par3, int par4, Explosion par5Explosion) {
      if (!par1World.isRemote) {
         EntityTNTPrimed var6 = (EntityTNTPrimed)EntityList.createEntityOfType(
            EntityTNTPrimed.class, par1World, (double)(par2 + 0.5F), (double)(par3 + 0.5F), (double)(par4 + 0.5F), par5Explosion.func_94613_c()
         );
   ...
   public void func_94391_a(World par1World, int par2, int par3, int par4, int par5, EntityLiving par6EntityLiving) {
      if (!par1World.isRemote && (par5 & 1) == 1) {
         ...
         if (par6EntityLiving == null) {
            var7 = (EntityTNTPrimed)EntityList.createEntityOfType(
               EntityTNTPrimed.class, par1World, (double)(par2 + 0.5F), (double)(par3 + 0.5F), (double)(par4 + 0.5F)
            );
         } else {
            var7 = (EntityTNTPrimed)EntityList.createEntityOfType(
               EntityTNTPrimed.class, par1World, (double)(par2 + 0.5F), (double)(par3 + 0.5F), (double)(par4 + 0.5F), par6EntityLiving
            );
         }
