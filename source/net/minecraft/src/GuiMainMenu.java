...
public class GuiMainMenu extends GuiScreen {
   ...
   public void drawScreen(int par1, int par2, float par3) {
      ...
      byte var7 = 30;
      this.a(0, 0, this.width, this.height, -2130706433, 16777215);
      ...
      var8 = var8 * 100.0F / (this.fontRenderer.getStringWidth(this.splashText) + 32);
      GL11.glScalef(var8, var8, var8);
      this.a(this.fontRenderer, this.splashText, 0, -8, 16776960);
      GL11.glPopMatrix();
      ...
      this.b(this.fontRenderer, var9, 2, this.height - 10, 16777215);
      String var10 = "Copyright Mojang AB. Do not distribute!";
      this.b(this.fontRenderer, var10, this.width - this.fontRenderer.getStringWidth(var10) - 2, this.height - 10, 16777215);
      if (this.field_92025_p != null && this.field_92025_p.length() > 0) {
         a(this.field_92022_t - 2, this.field_92021_u - 2, this.field_92020_v + 2, this.field_92019_w - 1, 1428160512);
         this.b(this.fontRenderer, this.field_92025_p, this.field_92022_t, this.field_92021_u, 16777215);
         this.b(this.fontRenderer, field_96138_a, (this.width - this.field_92024_r) / 2, ((GuiButton)this.buttonList.get(0)).yPosition - 12, 16777215);
      }
   ...
   protected void mouseClicked(int par1, int par2, int par3) {
      ...
      synchronized (this.field_104025_t) {
         if (this.field_92025_p.length() > 0
            ...
            GuiConfirmOpenLink var5x = new GuiConfirmOpenLink(this, this.field_104024_v, 13, true);
            var5x.func_92026_h();
