...
public class StructureStrongholdPieces {
   ...
   public static void prepareStructurePieces() {
      ...
      for (StructureStrongholdPieceWeight var3 : pieceWeightArray) {
   ...
   private static boolean canAddStructurePieces() {
      ...
      for (StructureStrongholdPieceWeight var2 : structurePieceList) {
   ...
   private static ComponentStronghold getStrongholdComponentFromWeightedPiece(
      Class var0, List var1, Random var2, int var3, int var4, int var5, int var6, int var7
   ) {
      Object var8 = null;
      if (var0 == ComponentStrongholdStraight.class) {
         ...
         var8 = ComponentStrongholdRightTurn.a(var1, var2, var3, var4, var5, var6, var7);
   ...
   private static ComponentStronghold getNextComponent(
      ComponentStrongholdStairs2 var0, List var1, Random var2, int var3, int var4, int var5, int var6, int var7
   ) {
      if (!canAddStructurePieces()) {
         ...
         return var14 != null && var14.minY > 1 ? new ComponentStrongholdCorridor(var7, var2, var14, var6) : null;
      }
   }
