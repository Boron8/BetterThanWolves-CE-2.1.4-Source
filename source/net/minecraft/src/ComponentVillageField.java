...
public class ComponentVillageField extends ComponentVillage {
   ...
   public static ComponentVillageField func_74900_a(
   ...
   public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox) {
      ...
      if (iAbandonmentLevel <= 1) {
         ...
         this.a(par1World, par3StructureBoundingBox, 7, 0, 1, 8, 0, 7, BTWBlocks.farmland.blockID, BTWBlocks.farmland.blockID, false);
         this.a(par1World, par3StructureBoundingBox, 10, 0, 1, 11, 0, 7, BTWBlocks.farmland.blockID, BTWBlocks.farmland.blockID, false);
      } else {
         ...
         this.a(par1World, par3StructureBoundingBox, 7, 0, 1, 8, 0, 7, BTWBlocks.looseDirt.blockID, BTWBlocks.looseDirt.blockID, false);
         this.a(par1World, par3StructureBoundingBox, 10, 0, 1, 11, 0, 7, BTWBlocks.looseDirt.blockID, BTWBlocks.looseDirt.blockID, false);
      }
      ...
      this.a(par1World, par3StructureBoundingBox, 12, 0, 0, 12, 0, 8, Block.wood.blockID, Block.wood.blockID, false);
      this.a(par1World, par3StructureBoundingBox, 1, 0, 0, 11, 0, 0, Block.wood.blockID, Block.wood.blockID, false);
      this.a(par1World, par3StructureBoundingBox, 1, 0, 8, 11, 0, 8, Block.wood.blockID, Block.wood.blockID, false);
      if (iAbandonmentLevel <= 1) {
         this.a(par1World, par3StructureBoundingBox, 3, 0, 1, 3, 0, 7, Block.waterMoving.blockID, Block.waterMoving.blockID, false);
         this.a(par1World, par3StructureBoundingBox, 9, 0, 1, 9, 0, 7, Block.waterMoving.blockID, Block.waterMoving.blockID, false);
      }
      ...
      for (int var4 = 1; var4 <= 7; var4++) {
         ...
         cropGrowth = MathHelper.getRandomIntegerInRange(par2Random, 2, 5) + 3;
         this.a(par1World, BTWBlocks.wheatCrop.blockID, cropGrowth, 4, 1, var4, par3StructureBoundingBox);
         if (cropGrowth == 7) {
            this.a(par1World, BTWBlocks.wheatCropTop.blockID, 3, 4, 2, var4, par3StructureBoundingBox);
         }

         cropGrowth = MathHelper.getRandomIntegerInRange(par2Random, 2, 5) + 3;
         this.a(par1World, BTWBlocks.wheatCrop.blockID, cropGrowth, 5, 1, var4, par3StructureBoundingBox);
         if (cropGrowth == 7) {
            this.a(par1World, BTWBlocks.wheatCropTop.blockID, 3, 5, 2, var4, par3StructureBoundingBox);
         }

         cropGrowth = MathHelper.getRandomIntegerInRange(par2Random, 2, 5) + 3;
         this.a(par1World, BTWBlocks.wheatCrop.blockID, cropGrowth, 7, 1, var4, par3StructureBoundingBox);
         if (cropGrowth == 7) {
            this.a(par1World, BTWBlocks.wheatCropTop.blockID, 3, 7, 2, var4, par3StructureBoundingBox);
         }

         cropGrowth = MathHelper.getRandomIntegerInRange(par2Random, 2, 5) + 3;
         this.a(par1World, BTWBlocks.wheatCrop.blockID, cropGrowth, 8, 1, var4, par3StructureBoundingBox);
         if (cropGrowth == 7) {
            this.a(par1World, BTWBlocks.wheatCropTop.blockID, 3, 8, 2, var4, par3StructureBoundingBox);
         }

         cropGrowth = MathHelper.getRandomIntegerInRange(par2Random, 2, 5) + 3;
         this.a(par1World, this.secondaryCrop, cropGrowth, 10, 1, var4, par3StructureBoundingBox);
         if (cropGrowth == 7 && this.secondaryCrop == BTWBlocks.wheatCrop.blockID) {
            this.a(par1World, BTWBlocks.wheatCropTop.blockID, 3, 10, 2, var4, par3StructureBoundingBox);
         }

         cropGrowth = MathHelper.getRandomIntegerInRange(par2Random, 2, 5) + 3;
         this.a(par1World, this.secondaryCrop, cropGrowth, 11, 1, var4, par3StructureBoundingBox);
         if (cropGrowth == 7 && this.secondaryCrop == BTWBlocks.wheatCrop.blockID) {
            this.a(par1World, BTWBlocks.wheatCropTop.blockID, 3, 11, 2, var4, par3StructureBoundingBox);
         }
         ...
         if (iAbandonmentLevel > 1) {
            ...
            this.a(par1World, 0, 0, 7, 1, var4, par3StructureBoundingBox);
            this.a(par1World, 0, 0, 8, 1, var4, par3StructureBoundingBox);
            this.a(par1World, 0, 0, 10, 1, var4, par3StructureBoundingBox);
            this.a(par1World, 0, 0, 11, 1, var4, par3StructureBoundingBox);
            ...
            this.a(par1World, 0, 0, 7, 2, var4, par3StructureBoundingBox);
            this.a(par1World, 0, 0, 8, 2, var4, par3StructureBoundingBox);
            this.a(par1World, 0, 0, 10, 2, var4, par3StructureBoundingBox);
            this.a(par1World, 0, 0, 11, 2, var4, par3StructureBoundingBox);
