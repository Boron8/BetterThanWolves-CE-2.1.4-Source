...
public class PanelCrashReport extends Panel {
   public PanelCrashReport(CrashReport var1) {
      this.setBackground(new Color(3028036));
      this.setLayout(new BorderLayout());
      StringWriter var2 = new StringWriter();
      var1.getCrashCause().printStackTrace(new PrintWriter(var2));
      ...
      if (var3.contains("Pixel format not accelerated")) {
         ...
         File var7 = var1.getFile();
         if (var7 == null) {
            var1.saveToFile(
               new File(
                  new File(Minecraft.getMinecraftDir(), "crash-reports"),
      ...
      var6 = var6 + "\n";
      var6 = var6 + "\n";
      TextArea var36 = new TextArea(var6, 0, 0, 1);
      var36.setFont(new Font("Monospaced", 0, 12));
