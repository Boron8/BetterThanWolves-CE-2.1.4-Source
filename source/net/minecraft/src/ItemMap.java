...
public class ItemMap extends ItemMapBase {
   ...
   public MapData getMapData(ItemStack par1ItemStack, World par2World) {
      ...
      if (var4 == null && !par2World.isRemote) {
         ...
         var4.xCenter = Math.round((float)par2World.getWorldInfo().getSpawnX() / var5) * var5;
   ...
   public void updateMapData(World par1World, Entity par2Entity, MapData par3MapData) {
      if (par1World.provider.dimensionId == par3MapData.dimension && par2Entity instanceof EntityPlayer) {
         ...
         int var9 = MathHelper.floor_double(par2Entity.posX - var7) / var6 + var4 / 2;
         int var10 = MathHelper.floor_double(par2Entity.posZ - var8) / var6 + var5 / 2;
         int var11 = 128 / var6;
                  ...
                  if (var13 >= 0 && var18 >= -1 && var13 < var4 && var18 < var5) {
                     ...
                     if (!var25.isEmpty()) {
                        ...
                        if (par1World.provider.hasNoSky) {
                           ...
                           if ((var31 >> 20 & 1) == 0) {
                              var24[Block.dirt.blockID] = var24[Block.dirt.blockID] + 10;
                           } else {
                              var24[Block.stone.blockID] = var24[Block.stone.blockID] + 10;
                           }
                           ...
                           for (int var31 = 0; var31 < var6; var31++) {
                              for (int var32 = 0; var32 < var6; var32++) {
                                 int var33 = var25.getHeightValue(var31 + var26, var32 + var27) + 1;
                                 int var34 = 0;
                                 int meta = 0;
                                 if (var33 > 1) {
                                    boolean var35;
                        ...
                        for (int var33 = 0; var33 < 4096; var33++) {
                           if (var24[var33] > var48) {
                              var32 = var33;
                              var48 = var24[var33];
                           }
                        }
                        ...
                        double var40 = (var29 - var16) * 4.0 / (var6 + 4) + ((var13 + var18 & 1) - 0.5) * 0.4;
                        byte var39 = 1;
                        if (var40 > 0.6) {
                           var39 = 2;
                        }
                        ...
                        if (var32 > 0) {
                           ...
                           if (var42 == MapColor.waterColor) {
                              var40 = var28 * 0.1 + (var13 + var18 & 1) * 0.2;
                              var39 = 1;
                              if (var40 < 0.5) {
                                 var39 = 2;
                              }
   ...
   public void onUpdate(ItemStack par1ItemStack, World par2World, EntityPlayer par3Entity, int par4, boolean par5) {
      if (!par2World.isRemote) {
         ...
         if (par3Entity instanceof EntityPlayer) {
            var6.updateVisiblePlayers(par3Entity, par1ItemStack);
         }
