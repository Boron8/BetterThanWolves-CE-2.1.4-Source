      ...
      if (par1World.isRemote) {
         ...
         if (par1World.provider.canRespawnHere() && par1World.getBiomeGenForCoords(par2, par4) != BiomeGenBase.hell) {
            if (isBedOccupied(var10)) {
               ...
               for (EntityPlayer var21 : par1World.playerEntities) {
            ...
            double var18 = par2 + 0.5;
            double var13 = par3 + 0.5;
            double var15 = par4 + 0.5;
            ...
            if (par1World.getBlockId(par2, par3, par4) == this.blockID) {
               par1World.setBlockToAir(par2, par3, par4);
               var18 = (var18 + par2 + 0.5) / 2.0;
               var13 = (var13 + par3 + 0.5) / 2.0;
               var15 = (var15 + par4 + 0.5) / 2.0;
            }
   ...
   public Icon getIcon(int par1, int par2) {
      if (par1 == 0) {
         ...
         return (var5 != 1 || var4 != 2) && (var5 != 0 || var4 != 3)
            ? (var4 != 5 && var4 != 4 ? this.bedTopIcons[var5] : this.bedSideIcons[var5])
            : this.field_94472_b[var5];
      }
   }
         ...
         for (int var12 = var8; var12 <= var10; var12++) {
            for (int var13 = var9; var13 <= var11; var13++) {
               if ((var12 != var8 && var12 != var10 || var13 != var9 && var13 != var11)
                  && par0World.doesBlockHaveSolidTopSurface(var12, par2 - 1, var13)
