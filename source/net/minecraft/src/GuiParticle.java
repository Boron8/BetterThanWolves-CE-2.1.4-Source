...
public class GuiParticle extends Gui {
   ...
   public void draw(float var1) {
      ...
      for (int var2 = 0; var2 < this.particles.size(); var2++) {
         ...
         int var4 = (int)(var3.prevPosX + (var3.posX - var3.prevPosX) * var1 - 4.0);
         int var5 = (int)(var3.prevPosY + (var3.posY - var3.prevPosY) * var1 - 4.0);
         float var6 = (float)(var3.prevTintAlpha + (var3.tintAlpha - var3.prevTintAlpha) * var1);
         float var7 = (float)(var3.prevTintRed + (var3.tintRed - var3.prevTintRed) * var1);
         float var8 = (float)(var3.prevTintGreen + (var3.tintGreen - var3.prevTintGreen) * var1);
         float var9 = (float)(var3.prevTintBlue + (var3.tintBlue - var3.prevTintBlue) * var1);
