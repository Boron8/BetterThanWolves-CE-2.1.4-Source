...
public class ModelWolf extends ModelBase {
   ...
   public void setLivingAnimations(EntityLiving par1EntityLiving, float par2, float par3, float par4) {
      ...
      if (!var5.bW() && !var5.isWildAndHostile()) {
      ...
      this.wolfHeadMain.rotateAngleZ = var5.k(par4) + var5.f(par4, 0.0F);
      this.wolfMane.rotateAngleZ = var5.f(par4, -0.08F);
      this.wolfBody.rotateAngleZ = var5.f(par4, -0.16F);
      this.wolfTail.rotateAngleZ = var5.f(par4, -0.2F);
      this.wolfHeadMain.rotationPointY = 13.5F + ((WolfEntity)par1EntityLiving).getGrazeHeadVerticalOffset(par4) * 5.0F;
      this.headRotation = ((WolfEntity)par1EntityLiving).getGrazeHeadRotation(par4);
      this.wolfHeadMain.rotateAngleZ = this.wolfHeadMain.rotateAngleZ + var5.getPossessionHeadRotation();
   }
   ...
   public void setRotationAngles(float par1, float par2, float par3, float par4, float par5, float par6, Entity par7Entity) {
      ...
      this.wolfHeadMain.rotateAngleX = this.headRotation;
   }
}
