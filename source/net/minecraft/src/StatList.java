...
public class StatList {
   ...
   public static StatBase startGameStat = new StatBasic(1000, "stat.startGame").h().registerStat();
   public static StatBase createWorldStat = new StatBasic(1001, "stat.createWorld").h().registerStat();
   public static StatBase loadWorldStat = new StatBasic(1002, "stat.loadWorld").h().registerStat();
   public static StatBase joinMultiplayerStat = new StatBasic(1003, "stat.joinMultiplayer").h().registerStat();
   public static StatBase leaveGameStat = new StatBasic(1004, "stat.leaveGame").h().registerStat();
   public static StatBase minutesPlayedStat = new StatBasic(1100, "stat.playOneMinute", StatBase.timeStatType).h().registerStat();
   public static StatBase distanceWalkedStat = new StatBasic(2000, "stat.walkOneCm", StatBase.distanceStatType).h().registerStat();
   public static StatBase distanceSwumStat = new StatBasic(2001, "stat.swimOneCm", StatBase.distanceStatType).h().registerStat();
   public static StatBase distanceFallenStat = new StatBasic(2002, "stat.fallOneCm", StatBase.distanceStatType).h().registerStat();
   public static StatBase distanceClimbedStat = new StatBasic(2003, "stat.climbOneCm", StatBase.distanceStatType).h().registerStat();
   public static StatBase distanceFlownStat = new StatBasic(2004, "stat.flyOneCm", StatBase.distanceStatType).h().registerStat();
   public static StatBase distanceDoveStat = new StatBasic(2005, "stat.diveOneCm", StatBase.distanceStatType).h().registerStat();
   public static StatBase distanceByMinecartStat = new StatBasic(2006, "stat.minecartOneCm", StatBase.distanceStatType).h().registerStat();
   public static StatBase distanceByBoatStat = new StatBasic(2007, "stat.boatOneCm", StatBase.distanceStatType).h().registerStat();
   public static StatBase distanceByPigStat = new StatBasic(2008, "stat.pigOneCm", StatBase.distanceStatType).h().registerStat();
   public static StatBase jumpStat = new StatBasic(2010, "stat.jump").h().registerStat();
   public static StatBase dropStat = new StatBasic(2011, "stat.drop").h().registerStat();
      ...
      if (blockStatsInitialized && itemStatsInitialized) {
         ...
         for (Integer var5 : var0) {
            if (Item.itemsList[var5] != null) {
               ...
               objectCraftStats[var5] = new StatCrafting(16842752 + var5, var3, var5).g();
            }
         }
   ...
   private static StatBase[] initMinableStats(String par0Str, int par1) {
      ...
      for (int var3 = 0; var3 < 4096; var3++) {
         if (Block.blocksList[var3] != null && Block.blocksList[var3].getEnableStats()) {
            ...
            var2[var3] = new StatCrafting(par1 + var3, var4, var3).g();
   ...
   private static StatBase[] initUsableStats(StatBase[] par0ArrayOfStatBase, String par1Str, int par2, int par3, int par4) {
      ...
      for (int var5 = par3; var5 < par4; var5++) {
         if (Item.itemsList[var5] != null) {
            ...
            par0ArrayOfStatBase[var5] = new StatCrafting(par2 + var5, var6, var5).g();
            if (var5 >= 256) {
