...
public class ModelSilverfish extends ModelBase {
   ...
   public ModelSilverfish() {
      ...
      for (int var2 = 0; var2 < this.silverfishBodyParts.length; var2++) {
         ...
         this.silverfishBodyParts[var2]
            .addBox(
               silverfishBoxLength[var2][0] * -0.5F,
               0.0F,
               silverfishBoxLength[var2][2] * -0.5F,
               silverfishBoxLength[var2][0],
               silverfishBoxLength[var2][1],
   ...
   public void render(Entity var1, float var2, float var3, float var4, float var5, float var6, float var7) {
      ...
      for (int var9 = 0; var9 < this.silverfishWings.length; var9++) {
         this.silverfishWings[var9].render(var7);
      }
   }
   ...
   public void setRotationAngles(float var1, float var2, float var3, float var4, float var5, float var6, Entity var7) {
      for (int var8 = 0; var8 < this.silverfishBodyParts.length; var8++) {
         this.silverfishBodyParts[var8].rotateAngleY = MathHelper.cos(var3 * 0.9F + var8 * 0.15F * (float) Math.PI)
            * (float) Math.PI
            * 0.05F
            * (1 + Math.abs(var8 - 2));
         this.silverfishBodyParts[var8].rotationPointX = MathHelper.sin(var3 * 0.9F + var8 * 0.15F * (float) Math.PI)
            * (float) Math.PI
            * 0.2F
            * Math.abs(var8 - 2);
      }
