...
public abstract class StructureComponent {
   ...
   public static StructureComponent findIntersecting(List par0List, StructureBoundingBox par1StructureBoundingBox) {
      for (StructureComponent var3 : par0List) {
   ...
   protected boolean isLiquidInStructureBoundingBox(World par1World, StructureBoundingBox par2StructureBoundingBox) {
      ...
      for (int var12 = var3; var12 <= var6; var12++) {
         for (int var10 = var4; var10 <= var7; var10++) {
            int var11x = par1World.getBlockId(var12, var10, var5);
            if (var11x > 0 && Block.blocksList[var11x].blockMaterial.isLiquid()) {
               return true;
            }

            var11x = par1World.getBlockId(var12, var10, var8);
            if (var11x > 0 && Block.blocksList[var11x].blockMaterial.isLiquid()) {
               return true;
            }
         }
      ...
      for (int var13 = var5; var13 <= var8; var13++) {
         for (int var10 = var4; var10 <= var7; var10++) {
            int var11xx = par1World.getBlockId(var3, var10, var13);
            if (var11xx > 0 && Block.blocksList[var11xx].blockMaterial.isLiquid()) {
               return true;
            }

            var11xx = par1World.getBlockId(var6, var10, var13);
            if (var11xx > 0 && Block.blocksList[var11xx].blockMaterial.isLiquid()) {
               return true;
            }
         }
         ...
         if (par1 != Block.stairsCobblestone.blockID
            ...
            if (par1 == Block.ladder.blockID) {
               ...
               if (par1 == Block.pistonBase.blockID
                  ...
                  || par1 == BTWBlocks.idleOven.blockID) {
                  if (this.coordBaseMode == 0) {
                     if (par2 == 2 || par2 == 3) {
   ...
   protected void fillWithMetadataBlocks(
      World par1World,
      StructureBoundingBox par2StructureBoundingBox,
      int par3,
      int par4,
            ...
            for (int var14 = par5; var14 <= par8; var14++) {
               if (!par9 || this.getBlockIdAtCurrentPosition(par1World, var13, var12, var14, par2StructureBoundingBox) != 0) {
                  par11StructurePieceBlockSelector.selectBlocks(
                     par10Random, var13, var12, var14, var12 == par4 || var12 == par7 || var13 == par3 || var13 == par6 || var14 == par5 || var14 == par8
                  );
                  this.placeBlockAtCurrentPosition(
                     par1World,
                     par11StructurePieceBlockSelector.getSelectedBlockId(),
                     par11StructurePieceBlockSelector.getSelectedBlockMetaData(),
                     var13,
                     var12,
                     var14,
         ...
         for (int var15 = par5; var15 <= par8; var15++) {
            for (int var16 = par7; var16 <= par10; var16++) {
               if (par3Random.nextFloat() <= par4
                  && (!par13 || this.getBlockIdAtCurrentPosition(par1World, var15, var14, var16, par2StructureBoundingBox) != 0)) {
   ...
   protected void randomlyPlaceBlock(
      World par1World, StructureBoundingBox par2StructureBoundingBox, Random par3Random, float par4, int par5, int par6, int par7, int par8, int par9
   ) {
      if (par3Random.nextFloat() < par4) {
   ...
   protected void randomlyRareFillWithBlocks(
      World par1World, StructureBoundingBox par2StructureBoundingBox, int par3, int par4, int par5, int par6, int par7, int par8, int par9, boolean par10
   ) {
   ...
   protected boolean generateStructureDispenserContents(
      World par1World,
      StructureBoundingBox par2StructureBoundingBox,
      Random par3Random,
      int par4,
   ...
   protected void placeDoorAtCurrentPosition(
      World par1World, StructureBoundingBox par2StructureBoundingBox, Random par3Random, int par4, int par5, int par6, int par7
   ) {
      int var8 = this.getXWithOffset(par4, par6);
      int var9 = this.getYWithOffset(par5);
      int var10 = this.getZWithOffset(par4, par6);
