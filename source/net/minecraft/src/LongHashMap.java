...
public class LongHashMap {
   ...
   private transient LongHashMapEntry[] hashArray = new LongHashMapEntry[2000];
   private transient int numHashElements;
   private int capacity = 1500;
   private transient volatile int modCount;

   private static int getHashedKey(long par0) {
      return hash((int)(par0 ^ (par0 >>> 32) * 31L));
   }
   ...
   private void copyHashTableTo(LongHashMapEntry[] par1ArrayOfLongHashMapEntry) {
      ...
      for (int var4 = 0; var4 < var2.length; var4++) {
         ...
         if (var5 != null) {
            ...
            while (true) {
               LongHashMapEntry var6 = var5.nextEntry;
   ...
   final LongHashMapEntry removeKey(long par1) {
      ...
      LongHashMapEntry var6 = var5;

      while (var6 != null) {
         LongHashMapEntry var7 = var6.nextEntry;
         if (var6.key == par1) {
            this.modCount++;
