...
public abstract class Request {
   ...
   public String func_96364_c() {
      try {
         this.func_96354_d();
         String var1 = this.func_96362_a() >= 400
            ? this.func_96352_a(this.field_96367_a.getErrorStream())
            : this.func_96352_a(this.field_96367_a.getInputStream());
         this.func_96360_f();
         return var1;
   ...
   private String func_96352_a(InputStream var1) {
      if (var1 == null) {
   ...
   private void func_96360_f() {
      ...
      try {
         boolean var2 = false;
         InputStream var7 = this.field_96367_a.getInputStream();

         while (var7.read(var1) > 0) {
         }

         var7.close();
      } catch (Exception var6) {
         try {
            InputStream var3 = this.field_96367_a.getErrorStream();
            boolean var4 = false;
