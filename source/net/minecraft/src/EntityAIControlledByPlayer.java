...
public class EntityAIControlledByPlayer extends EntityAIBase {
   ...
   public void updateTask() {
      ...
      if (this.thisEntity.onGround) {
         var8 = 0.54600006F;
         int var9 = this.thisEntity.worldObj.getBlockId(MathHelper.floor_float(var4), MathHelper.floor_float(var5) - 1, MathHelper.floor_float(var6));
         if (var9 > 0) {
      ...
      if (var4 != var17 || var6 != var18) {
         ...
         if (!var22
            && PathFinder.func_82565_a(this.thisEntity, var17, var5, var18, var19, false, false, true) == 0
            && PathFinder.func_82565_a(this.thisEntity, var4, var5 + 1, var6, var19, false, false, true) == 1
            && PathFinder.func_82565_a(this.thisEntity, var17, var5 + 1, var18, var19, false, false, true) == 1) {
            var2.aB().setJumping();
         }
      }
      ...
      if (!var1.capabilities.isCreativeMode && this.currentSpeed >= this.maxSpeed * 0.5F && this.thisEntity.getRNG().nextFloat() < 0.006F && !this.speedBoosted
         )
       {
         ...
         if (var25 != null && var25.itemID == Item.carrotOnAStick.itemID) {
            var25.damageItem(1, var1);
            if (var25.stackSize == 0) {
               ItemStack var26 = new ItemStack(Item.fishingRod);
               var26.setTagCompound(var25.stackTagCompound);
               var1.inventory.mainInventory[var1.inventory.currentItem] = var26;
            }
         }
      }
