...
public class BlockDispenser extends BlockContainer {
   ...
   public Icon getIcon(int par1, int par2) {
      int var3 = par2 & 7;
      return par1 == var3
         ? (var3 != 1 && var3 != 0 ? this.furnaceFrontIcon : this.field_96473_e)
         : (var3 != 1 && var3 != 0 ? (par1 != 1 && par1 != 0 ? this.blockIcon : this.furnaceTopIcon) : this.furnaceTopIcon);
   }
   ...
   public static IPosition getIPositionFromBlockSource(IBlockSource par0IBlockSource) {
      ...
      double var2 = par0IBlockSource.getX() + 0.7 * var1.getFrontOffsetX();
      double var4 = par0IBlockSource.getY() + 0.7 * var1.getFrontOffsetY();
      double var6 = par0IBlockSource.getZ() + 0.7 * var1.getFrontOffsetZ();
