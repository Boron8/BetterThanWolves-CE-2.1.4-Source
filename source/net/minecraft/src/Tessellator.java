         ...
         if (this.vertexCount > 0) {
            ...
            if (this.hasBrightness) {
               ...
               if (this.useVBO) {
                  ...
                  ((Buffer)this.shortBuffer).position(14);
            ...
            if (this.hasNormals) {
               if (this.useVBO) {
                  ...
                  ((Buffer)this.byteBuffer).position(24);
