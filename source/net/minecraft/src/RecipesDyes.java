...
public class RecipesDyes {
   public void addRecipes(CraftingManager var1) {
      for (int var2 = 0; var2 < 16; var2++) {
         var1.addShapelessRecipe(
            new ItemStack(Block.cloth, 1, BlockCloth.getDyeFromBlock(var2)),
      ...
      var1.addShapelessRecipe(
         new ItemStack(Item.dyePowder, 3, 7), new ItemStack(Item.dyePowder, 1, 0), new ItemStack(Item.dyePowder, 1, 15), new ItemStack(Item.dyePowder, 1, 15)
      );
      ...
      var1.addShapelessRecipe(
         new ItemStack(Item.dyePowder, 3, 13), new ItemStack(Item.dyePowder, 1, 4), new ItemStack(Item.dyePowder, 1, 1), new ItemStack(Item.dyePowder, 1, 9)
      );
      var1.addShapelessRecipe(
         new ItemStack(Item.dyePowder, 4, 13),
