...
public class GuiCreateFlatWorld extends GuiScreen {
   ...
   public void initGui() {
      ...
      this.buttonList
         .add(
            this.buttonAddLayer = new GuiButton(
               2, this.width / 2 - 154, this.height - 52, 100, 20, StatCollector.translateToLocal("createWorld.customize.flat.addLayer") + " (NYI)"
            )
         );
      this.buttonList
         .add(
            this.buttonEditLayer = new GuiButton(
               3, this.width / 2 - 50, this.height - 52, 100, 20, StatCollector.translateToLocal("createWorld.customize.flat.editLayer") + " (NYI)"
            )
         );
      this.buttonList
         .add(
            this.buttonRemoveLayer = new GuiButton(
               4, this.width / 2 - 155, this.height - 52, 150, 20, StatCollector.translateToLocal("createWorld.customize.flat.removeLayer")
            )
         );
   ...
   protected void actionPerformed(GuiButton var1) {
      ...
      if (var1.id == 1) {
         ...
         this.createFlatWorldListSlotGui.field_82454_a = Math.min(
            this.createFlatWorldListSlotGui.field_82454_a, this.theFlatGeneratorInfo.getFlatLayers().size() - 1
         );
      }
   ...
   public void drawScreen(int var1, int var2, float var3) {
      ...
      this.a(this.fontRenderer, this.customizationTitle, this.width / 2, 8, 16777215);
      int var4 = this.width / 2 - 92 - 16;
      this.b(this.fontRenderer, this.layerMaterialLabel, var4, 32, 16777215);
      this.b(this.fontRenderer, this.heightLabel, var4 + 2 + 213 - this.fontRenderer.getStringWidth(this.heightLabel), 32, 16777215);
