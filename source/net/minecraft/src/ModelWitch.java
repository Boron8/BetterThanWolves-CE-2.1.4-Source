...
public class ModelWitch extends ModelVillager {
   ...
   public ModelWitch(float var1) {
      ...
      var4.rotateAngleX = (float) (-Math.PI / 15);
   ...
   public void setRotationAngles(float var1, float var2, float var3, float var4, float var5, float var6, Entity var7) {
      ...
      float var8 = 0.01F * (var7.entityId % 10);
      this.field_82898_f.rotateAngleX = MathHelper.sin(var7.ticksExisted * var8) * 4.5F * (float) Math.PI / 180.0F;
      this.field_82898_f.rotateAngleY = 0.0F;
      this.field_82898_f.rotateAngleZ = MathHelper.cos(var7.ticksExisted * var8) * 2.5F * (float) Math.PI / 180.0F;
