...
public abstract class WorldProvider {
   ...
   public IChunkProvider createChunkGenerator() {
      return (IChunkProvider)(this.terrainType == WorldType.FLAT
         ? new ChunkProviderFlat(this.worldObj, this.worldObj.getSeed(), this.worldObj.getWorldInfo().isMapFeaturesEnabled(), this.field_82913_c)
   ...
   public float calculateCelestialAngle(long par1, float par3) {
      ...
      float var7 = 1.0F - (float)((Math.cos(var5 * Math.PI) + 1.0) / 2.0);
