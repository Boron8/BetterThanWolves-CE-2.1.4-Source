...
public class CreativeTabs {
   ...
   public static final CreativeTabs tabAllSearch = new CreativeTabSearch(5, "search").a("search.png");
   ...
   public static final CreativeTabs tabInventory = new CreativeTabInventory(11, "inventory").a("survival_inv.png").setNoScrollbar().setNoTitle();
