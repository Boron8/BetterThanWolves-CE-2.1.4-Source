...
public class NetClientHandler extends NetHandler {
   ...
   public void handleLogin(Packet1Login par1Packet1Login) {
      ...
      this.worldClient = new WorldClient(
         this,
         new WorldSettings(0L, par1Packet1Login.gameType, false, par1Packet1Login.hardcoreMode, par1Packet1Login.terrainType, Difficulties.STANDARD),
         par1Packet1Login.dimension,
   ...
   public void handleVehicleSpawn(Packet23VehicleSpawn par1Packet23VehicleSpawn) {
      double var2 = par1Packet23VehicleSpawn.xPosition / 32.0;
      double var4 = par1Packet23VehicleSpawn.yPosition / 32.0;
      double var6 = par1Packet23VehicleSpawn.zPosition / 32.0;
      Object var8 = null;
      if (par1Packet23VehicleSpawn.type == 10) {
         ...
         var8 = EntityList.createEntityOfType(
            EntityItemFrame.class, this.worldClient, (int)var2, (int)var4, (int)var6, par1Packet23VehicleSpawn.throwerEntityId
         );
         par1Packet23VehicleSpawn.throwerEntityId = 0;
         ...
         var8 = EntityList.createEntityOfType(
            ...
            var4,
            var6,
            par1Packet23VehicleSpawn.speedX / 8000.0,
            par1Packet23VehicleSpawn.speedY / 8000.0,
            par1Packet23VehicleSpawn.speedZ / 8000.0
         );
         par1Packet23VehicleSpawn.throwerEntityId = 0;
         ...
         var8 = EntityList.createEntityOfType(InfiniteArrowEntity.class, this.worldClient, var2, var4, var6);
      } else if (par1Packet23VehicleSpawn.type == BroadheadArrowEntity.getVehicleSpawnPacketType()) {
         var8 = EntityList.createEntityOfType(BroadheadArrowEntity.class, this.worldClient, var2, var4, var6);
      } else if (par1Packet23VehicleSpawn.type == MovingPlatformEntity.getVehicleSpawnPacketType()) {
         var8 = EntityList.createEntityOfType(MovingPlatformEntity.class, this.worldClient, var2, var4, var6);
      } else if (par1Packet23VehicleSpawn.type == MovingAnchorEntity.getVehicleSpawnPacketType()) {
         var8 = EntityList.createEntityOfType(MovingAnchorEntity.class, this.worldClient, var2, var4, var6);
      } else if (par1Packet23VehicleSpawn.type == RottenArrowEntity.getVehicleSpawnPacketType()) {
         var8 = EntityList.createEntityOfType(RottenArrowEntity.class, this.worldClient, var2, var4, var6);
      } else if (par1Packet23VehicleSpawn.type == CorpseEyeEntity.getVehicleSpawnPacketType()) {
         var8 = EntityList.createEntityOfType(CorpseEyeEntity.class, this.worldClient, var2, var4, var6);
      }
      ...
      if (var8 != null) {
         ...
         if (par1Packet23VehicleSpawn.throwerEntityId > 0) {
            ...
            ((Entity)var8)
               .setVelocity(par1Packet23VehicleSpawn.speedX / 8000.0, par1Packet23VehicleSpawn.speedY / 8000.0, par1Packet23VehicleSpawn.speedZ / 8000.0);
         }
      }
   }
   ...
   public void handleEntityExpOrb(Packet26EntityExpOrb par1Packet26EntityExpOrb) {
      double posX = par1Packet26EntityExpOrb.posX / 32.0;
      double posY = par1Packet26EntityExpOrb.posY / 32.0;
      double posZ = par1Packet26EntityExpOrb.posZ / 32.0;
      EntityXPOrb var2 = (EntityXPOrb)EntityList.createEntityOfType(
         EntityXPOrb.class, this.worldClient, posX, posY, posZ, par1Packet26EntityExpOrb.xpValue, par1Packet26EntityExpOrb.notPlayerOwned
      );
   ...
   public void handleWeather(Packet71Weather par1Packet71Weather) {
      double var2 = par1Packet71Weather.posX / 32.0;
      double var4 = par1Packet71Weather.posY / 32.0;
      double var6 = par1Packet71Weather.posZ / 32.0;
      LightningBoltEntity var8 = null;
      if (par1Packet71Weather.isLightningBolt == 1) {
         var8 = (LightningBoltEntity)EntityList.createEntityOfType(LightningBoltEntity.class, this.worldClient, var2, var4, var6);
      }
      ...
      if (var8 != null) {
         ...
         this.worldClient.c(var8);
      }
   }

   @Override
   public void handleEntityPainting(Packet25EntityPainting par1Packet25EntityPainting) {
      EntityPainting var2 = (EntityPainting)EntityList.createEntityOfType(
   ...
   public void handleNamedEntitySpawn(Packet20NamedEntitySpawn par1Packet20NamedEntitySpawn) {
      double var2 = par1Packet20NamedEntitySpawn.xPosition / 32.0;
      double var4 = par1Packet20NamedEntitySpawn.yPosition / 32.0;
      double var6 = par1Packet20NamedEntitySpawn.zPosition / 32.0;
      float var8 = par1Packet20NamedEntitySpawn.rotation * 360 / 256.0F;
      float var9 = par1Packet20NamedEntitySpawn.pitch * 360 / 256.0F;
      EntityOtherPlayerMP var10 = (EntityOtherPlayerMP)EntityList.createEntityOfType(
         EntityOtherPlayerMP.class, this.mc.theWorld, par1Packet20NamedEntitySpawn.name
      );
      ...
      if (var12 != null) {
         var10.u().updateWatchedObjectsFromList(var12);
      }
   }
   ...
   public void handleEntity(Packet30Entity par1Packet30Entity) {
      ...
      if (var2 != null) {
         var2.serverPosX = var2.serverPosX + par1Packet30Entity.xPosition;
         var2.serverPosY = var2.serverPosY + par1Packet30Entity.yPosition;
         var2.serverPosZ = var2.serverPosZ + par1Packet30Entity.zPosition;
         double var3 = var2.serverPosX / 32.0;
   ...
   public void handleFlying(Packet10Flying par1Packet10Flying) {
      ...
      if (!this.doneLoadingTerrain) {
         ...
         this.awaitingChunkLoadToDisableGUIScreen = true;
         this.updatesSinceTerrainLoaded = 0;
      }
   }
   ...
   public void handleMapChunk(Packet51MapChunk par1Packet51MapChunk) {
      ...
      this.worldClient
         .invalidateBlockReceiveRegion(
            par1Packet51MapChunk.xCh << 4, 0, par1Packet51MapChunk.zCh << 4, (par1Packet51MapChunk.xCh << 4) + 15, 256, (par1Packet51MapChunk.zCh << 4) + 15
         );
      Chunk var2 = this.worldClient.e(par1Packet51MapChunk.xCh, par1Packet51MapChunk.zCh);
      if (par1Packet51MapChunk.includeInitialize && var2 == null) {
         this.worldClient.doPreChunk(par1Packet51MapChunk.xCh, par1Packet51MapChunk.zCh, true);
         var2 = this.worldClient.e(par1Packet51MapChunk.xCh, par1Packet51MapChunk.zCh);
      }

      if (var2 != null) {
         var2.fillChunk(
            par1Packet51MapChunk.getCompressedChunkData(), par1Packet51MapChunk.yChMin, par1Packet51MapChunk.yChMax, par1Packet51MapChunk.includeInitialize
         );
         this.worldClient
            .g(par1Packet51MapChunk.xCh << 4, 0, par1Packet51MapChunk.zCh << 4, (par1Packet51MapChunk.xCh << 4) + 15, 256, (par1Packet51MapChunk.zCh << 4) + 15);
   ...
   public void handleBlockChange(Packet53BlockChange par1Packet53BlockChange) {
      this.worldClient
         .setBlockAndMetadataAndInvalidate(
            ...
            par1Packet53BlockChange.type,
            par1Packet53BlockChange.metadata
         );
   }
   ...
   public void handleKickDisconnect(Packet255KickDisconnect par1Packet255KickDisconnect) {
      ...
      if (this.field_98183_l != null) {
         this.mc
            .displayGuiScreen(
               new GuiScreenDisconnectedOnline(this.field_98183_l, "disconnect.disconnected", "disconnect.genericReason", par1Packet255KickDisconnect.reason)
            );
      } else {
         this.mc
            .displayGuiScreen(
               new GuiDisconnected(
                  new GuiMultiplayer(new GuiMainMenu()), "disconnect.disconnected", "disconnect.genericReason", par1Packet255KickDisconnect.reason
               )
            );
      }
   }
   ...
   public void handleCollect(Packet22Collect par1Packet22Collect) {
      ...
      if (var2 != null) {
         if (var2 instanceof EntityXPOrb) {
            this.worldClient.a(var2, "random.orb", 0.2F, ((this.rand.nextFloat() - this.rand.nextFloat()) * 0.7F + 1.0F) * 2.0F);
         } else {
            this.worldClient.a(var2, "random.pop", 0.2F, ((this.rand.nextFloat() - this.rand.nextFloat()) * 0.7F + 1.0F) * 2.0F);
         }
   ...
   public void handleMobSpawn(Packet24MobSpawn par1Packet24MobSpawn) {
      double var2 = par1Packet24MobSpawn.xPosition / 32.0;
      double var4 = par1Packet24MobSpawn.yPosition / 32.0;
      double var6 = par1Packet24MobSpawn.zPosition / 32.0;
      ...
      if (var14 != null) {
         var10.u().updateWatchedObjectsFromList(var14);
      }
   }

   @Override
   public void handleUpdateTime(Packet4UpdateTime par1Packet4UpdateTime) {
      this.mc.theWorld.a(par1Packet4UpdateTime.worldAge);
      this.mc.theWorld.b(par1Packet4UpdateTime.time);
   }
   ...
   public void handleSpawnPosition(Packet6SpawnPosition par1Packet6SpawnPosition) {
      this.mc
         .thePlayer
         .a(new ChunkCoordinates(par1Packet6SpawnPosition.xPosition, par1Packet6SpawnPosition.yPosition, par1Packet6SpawnPosition.zPosition), true);
      this.mc.theWorld.M().setSpawnPosition(par1Packet6SpawnPosition.xPosition, par1Packet6SpawnPosition.yPosition, par1Packet6SpawnPosition.zPosition);
   }
   ...
   public void handleUpdateHealth(Packet8UpdateHealth par1Packet8UpdateHealth) {
      ...
      this.mc.thePlayer.cn().setFoodLevel(par1Packet8UpdateHealth.food);
      this.mc.thePlayer.cn().setFoodSaturationLevel(par1Packet8UpdateHealth.foodSaturation);
   }

   @Override
   public void handleExperience(Packet43Experience par1Packet43Experience) {
      this.mc.thePlayer.a(par1Packet43Experience.experience, par1Packet43Experience.experienceTotal, par1Packet43Experience.experienceLevel);
   }
   ...
   public void handleRespawn(Packet9Respawn par1Packet9Respawn) {
      if (par1Packet9Respawn.respawnDimension != this.mc.thePlayer.dimension) {
         ...
         Scoreboard var2 = this.worldClient.W();
         this.worldClient = new WorldClient(
            this,
            new WorldSettings(
               0L,
               par1Packet9Respawn.gameType,
               false,
               this.mc.theWorld.M().isHardcoreModeEnabled(),
               par1Packet9Respawn.terrainType,
               this.mc.theWorld.M().getDifficulty()
            ),
   ...
   public void handleExplosion(Packet60Explosion par1Packet60Explosion) {
      ...
      this.mc.thePlayer.motionX = this.mc.thePlayer.motionX + par1Packet60Explosion.getPlayerVelocityX();
      this.mc.thePlayer.motionY = this.mc.thePlayer.motionY + par1Packet60Explosion.getPlayerVelocityY();
      this.mc.thePlayer.motionZ = this.mc.thePlayer.motionZ + par1Packet60Explosion.getPlayerVelocityZ();
   }
   ...
   public void handleOpenWindow(Packet100OpenWindow par1Packet100OpenWindow) {
      ...
      switch (par1Packet100OpenWindow.inventoryType) {
         case 0:
            var2.a(new InventoryBasic(par1Packet100OpenWindow.windowTitle, par1Packet100OpenWindow.useProvidedWindowTitle, par1Packet100OpenWindow.slotsCount));
            var2.openContainer.windowId = par1Packet100OpenWindow.windowId;
            break;
         case 1:
            var2.b(MathHelper.floor_double(var2.posX), MathHelper.floor_double(var2.posY), MathHelper.floor_double(var2.posZ));
            var2.openContainer.windowId = par1Packet100OpenWindow.windowId;
            break;
         case 2:
         ...
         case 4:
            var2.a(
               ...
               par1Packet100OpenWindow.useProvidedWindowTitle ? par1Packet100OpenWindow.windowTitle : null
            );
            var2.openContainer.windowId = par1Packet100OpenWindow.windowId;
            break;
         case 5:
            ...
            break;
         case 6:
            var2.a(new NpcMerchant(var2), par1Packet100OpenWindow.useProvidedWindowTitle ? par1Packet100OpenWindow.windowTitle : null);
            var2.openContainer.windowId = par1Packet100OpenWindow.windowId;
            break;
         case 7:
            ...
            break;
         case 8:
            var2.c(MathHelper.floor_double(var2.posX), MathHelper.floor_double(var2.posY), MathHelper.floor_double(var2.posZ));
            var2.openContainer.windowId = par1Packet100OpenWindow.windowId;
            break;
         case 9:
         ...
         case 10:
            ...
            if (par1Packet100OpenWindow.useProvidedWindowTitle) {
               var6.a(par1Packet100OpenWindow.windowTitle);
            }
   ...
   public void handleUpdateSign(Packet130UpdateSign par1Packet130UpdateSign) {
      boolean var2 = false;
      if (this.mc.theWorld.f(par1Packet130UpdateSign.xPosition, par1Packet130UpdateSign.yPosition, par1Packet130UpdateSign.zPosition)) {
         TileEntity var3 = this.mc.theWorld.r(par1Packet130UpdateSign.xPosition, par1Packet130UpdateSign.yPosition, par1Packet130UpdateSign.zPosition);
   ...
   public void handleTileEntityData(Packet132TileEntityData par1Packet132TileEntityData) {
      if (this.mc.theWorld.f(par1Packet132TileEntityData.xPosition, par1Packet132TileEntityData.yPosition, par1Packet132TileEntityData.zPosition)) {
         TileEntity var2 = this.mc
            .theWorld
            .r(par1Packet132TileEntityData.xPosition, par1Packet132TileEntityData.yPosition, par1Packet132TileEntityData.zPosition);
         if (var2 != null) {
   ...
   public void handleUpdateProgressbar(Packet105UpdateProgressbar par1Packet105UpdateProgressbar) {
      EntityClientPlayerMP var2 = this.mc.thePlayer;
      this.a(par1Packet105UpdateProgressbar);
   ...
   public void handleBlockEvent(Packet54PlayNoteBlock par1Packet54PlayNoteBlock) {
      this.mc
         .theWorld
         .d(
            par1Packet54PlayNoteBlock.xLocation,
   ...
   public void handleMapChunks(Packet56MapChunks par1Packet56MapChunks) {
      for (int var2 = 0; var2 < par1Packet56MapChunks.getNumberOfChunkInPacket(); var2++) {
         ...
         Chunk var5 = this.worldClient.e(var3, var4);
         if (var5 == null) {
            this.worldClient.doPreChunk(var3, var4, true);
            var5 = this.worldClient.e(var3, var4);
         }

         if (var5 != null) {
            var5.fillChunk(
               par1Packet56MapChunks.getChunkCompressedData(var2), par1Packet56MapChunks.field_73590_a[var2], par1Packet56MapChunks.field_73588_b[var2], true
            );
            this.worldClient.g(var3 << 4, 0, var4 << 4, (var3 << 4) + 15, 256, (var4 << 4) + 15);
   ...
   public void handleGameEvent(Packet70GameEvent par1Packet70GameEvent) {
      ...
      if (var3 >= 0 && var3 < Packet70GameEvent.clientMessage.length && Packet70GameEvent.clientMessage[var3] != null) {
         var2.b(Packet70GameEvent.clientMessage[var3]);
      }

      if (var3 == 1) {
         this.worldClient.M().setRaining(true);
         this.worldClient.j(0.0F);
         if (var4 != 0) {
            this.worldClient.j(1.0F);
         }
      } else if (var3 == 2) {
         this.worldClient.M().setRaining(false);
         this.worldClient.j(1.0F);
      } else if (var3 == 3) {
         ...
         this.worldClient.playSound(var2.posX, var2.posY + var2.e(), var2.posZ, "random.successful_hit", 0.18F, 0.45F, false);
      }

      if (var3 == 7) {
         this.worldClient.M().setThundering(true);
         if (var4 == 0) {
         ...
         this.worldClient.M().setThundering(false);
         this.worldClient.prevThunderingStrength = this.worldClient.thunderingStrength = 1.0F;
      }
   }
   ...
   public void handleEntityEffect(Packet41EntityEffect par1Packet41EntityEffect) {
      ...
      if (var2 instanceof EntityLiving) {
         ...
         PotionEffect var3 = new PotionEffect(
            par1Packet41EntityEffect.effectId, par1Packet41EntityEffect.duration, par1Packet41EntityEffect.effectAmplifier, bIsAmbient
         );
   ...
   public void handleLevelSound(Packet62LevelSound par1Packet62LevelSound) {
      this.mc
         .theWorld
         .playSound(
            par1Packet62LevelSound.getEffectX(),
            ...
            par1Packet62LevelSound.getPitch(),
            false
         );
   }
               ...
               this.mc
                  .displayGuiScreen(
                     new GuiYesNo(
                        ...
                        StringTranslate.getInstance().translateKey("multiplayer.texturePrompt.line1"),
                        StringTranslate.getInstance().translateKey("multiplayer.texturePrompt.line2"),
                        0
                     )
                  );
            }
   ...
   public void handleSetObjective(Packet206SetObjective par1Packet206SetObjective) {
      ...
      if (par1Packet206SetObjective.change == 0) {
         ScoreObjective var3 = var2.func_96535_a(par1Packet206SetObjective.objectiveName, ScoreObjectiveCriteria.field_96641_b);
         var3.setDisplayName(par1Packet206SetObjective.objectiveDisplayName);
      } else {
         ScoreObjective var3 = var2.getObjective(par1Packet206SetObjective.objectiveName);
   ...
   public void handleSetPlayerTeam(Packet209SetPlayerTeam par1Packet209SetPlayerTeam) {
      ...
      if (par1Packet209SetPlayerTeam.mode == 0 || par1Packet209SetPlayerTeam.mode == 3) {
         for (String var5 : par1Packet209SetPlayerTeam.playerNames) {
   ...
   public void handleWorldParticles(Packet63WorldParticles par1Packet63WorldParticles) {
      for (int var2 = 0; var2 < par1Packet63WorldParticles.getQuantity(); var2++) {
         double var3 = this.rand.nextGaussian() * par1Packet63WorldParticles.getOffsetX();
         double var5 = this.rand.nextGaussian() * par1Packet63WorldParticles.getOffsetY();
         double var7 = this.rand.nextGaussian() * par1Packet63WorldParticles.getOffsetZ();
         double var9 = this.rand.nextGaussian() * par1Packet63WorldParticles.getSpeed();
         double var11 = this.rand.nextGaussian() * par1Packet63WorldParticles.getSpeed();
         double var13 = this.rand.nextGaussian() * par1Packet63WorldParticles.getSpeed();
         this.worldClient
            .a(
               ...
               par1Packet63WorldParticles.getPositionZ() + var7,
               var9,
               var11,
               var13
            );
   ...
   private void updateTerrainLoad() {
      if (this.awaitingChunkLoadToDisableGUIScreen) {
         if (this.isTerrainAroundPlayerLoaded()) {
            this.updatesSinceTerrainLoaded++;
            if (this.updatesSinceTerrainLoaded > 20) {
               this.doneLoadingTerrain = true;
               this.mc.displayGuiScreen((GuiScreen)null);
               this.awaitingChunkLoadToDisableGUIScreen = false;
            }
         } else {
            this.updatesSinceTerrainLoaded = 0;
         }
   ...
   public boolean isTerrainAroundPlayerLoaded() {
      int iPlayerBlockI = (int)this.mc.thePlayer.posX;
      int iPlayerBlockK = (int)this.mc.thePlayer.posZ;
      int iScanRange = 48;
      ...
      for (int iTempI = iPlayerBlockI - iScanRange; iTempI <= iPlayerBlockI + iScanRange; iTempI += 16) {
         for (int iTempK = iPlayerBlockK - iScanRange; iTempK <= iPlayerBlockK + iScanRange; iTempK += 16) {
            Chunk tempChunk = this.worldClient.d(iTempI, iTempK);
   ...
   public void handlePlayerSync(PlayerSyncPacket packet) {
      ...
      for (int i = 0; i < this.worldClient.playerEntities.size(); i++) {
         EntityPlayer otherPlayer = (EntityPlayer)this.worldClient.playerEntities.get(i);
         EntityPlayer thisPlayer = this.mc.thePlayer;
         if (otherPlayer.username.equals(packet.playerName) && thisPlayer.d(otherPlayer) < 110.0F) {
