         ...
         if (var1.length <= ++var3) {
            ...
            try {
               ...
               MinecraftServer.getServer()
                  .getLogAgent()
                  .logWarningException("Could not read creation date format for ban entry '" + var2.getBannedUsername() + "' (was: '" + var1[var3] + "')", var6);
            }
               ...
               if (var1.length <= ++var3) {
                  ...
                  try {
                     ...
                     MinecraftServer.getServer()
                        .getLogAgent()
                        .logWarningException(
                           "Could not read expiry date format for ban entry '" + var2.getBannedUsername() + "' (was: '" + var1[var3] + "')", var5
                        );
                  }
