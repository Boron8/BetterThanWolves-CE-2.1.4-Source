...
public class ModelBlaze extends ModelBase {
   ...
   public void setRotationAngles(float var1, float var2, float var3, float var4, float var5, float var6, Entity var7) {
      ...
      for (int var9 = 0; var9 < 4; var9++) {
         this.blazeSticks[var9].rotationPointY = -2.0F + MathHelper.cos((var9 * 2 + var3) * 0.25F);
      ...
      var8 = (float) (Math.PI / 4) + var3 * (float) Math.PI * 0.03F;

      for (int var12 = 4; var12 < 8; var12++) {
         this.blazeSticks[var12].rotationPointY = 2.0F + MathHelper.cos((var12 * 2 + var3) * 0.25F);
      ...
      for (int var13 = 8; var13 < 12; var13++) {
         this.blazeSticks[var13].rotationPointY = 11.0F + MathHelper.cos((var13 * 1.5F + var3) * 0.5F);
