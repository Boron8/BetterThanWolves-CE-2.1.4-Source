...
public class JungleTreeGenerator extends WorldGenerator {
   ...
   public boolean generate(World par1World, Random par2Random, int par3, int par4, int par5) {
      int i = par2Random.nextInt(3) + this.field_48195_a;
      boolean flag = true;
      if (par4 >= 1 && par4 + i + 1 <= 256) {
            ...
            for (int i1 = par3 - byte0; i1 <= par3 + byte0 && flag; i1++) {
               for (int k1 = par5 - byte0; k1 <= par5 + byte0 && flag; k1++) {
                  if (j >= 0 && j < 256) {
                     ...
                     if (!par1World.isAirBlock(i1, j, k1)
         ...
         if (!flag) {
            ...
            if (TreeUtils.canSaplingGrowOnBlock(par1World, par3, par4 - 1, par5) && par4 < 256 - i - 1) {
               ...
               this.func_48192_a(par1World, par3, par5, par4 + i, 2, par2Random);
               ...
               for (int l = par4 + i - 2 - par2Random.nextInt(4); l > par4 + i / 2; l -= 2 + par2Random.nextInt(4)) {
                  ...
                  int l1 = par3 + (int)(0.5F + MathHelper.cos(f) * 4.0F);
                  int l2 = par5 + (int)(0.5F + MathHelper.sin(f) * 4.0F);
                  this.func_48192_a(par1World, l1, l2, l, 0, par2Random);

                  for (int j3 = 0; j3 < 5; j3++) {
                     int i2 = par3 + (int)(1.5F + MathHelper.cos(f) * j3);
                     int i3 = par5 + (int)(1.5F + MathHelper.sin(f) * j3);
                     this.a(par1World, i2, l - 3 + j3 / 2, i3, Block.wood.blockID, this.woodMetadata);
                  }
               }
               ...
               for (int j1 = 0; j1 < i; j1++) {
                  ...
                  if (par1World.isAirBlock(par3, par4 + j1, par5) || j2 == Block.leaves.blockID) {
                     this.a(par1World, par3, par4 + j1, par5, Block.wood.blockID, this.woodMetadata);
                     if (j1 > 0) {
                        if (par2Random.nextInt(3) > 0 && par1World.isAirBlock(par3 - 1, par4 + j1, par5)) {
                           this.a(par1World, par3 - 1, par4 + j1, par5, Block.vine.blockID, 8);
                        }

                        if (par2Random.nextInt(3) > 0 && par1World.isAirBlock(par3, par4 + j1, par5 - 1)) {
                           this.a(par1World, par3, par4 + j1, par5 - 1, Block.vine.blockID, 1);
                        }
                     }
                  }
                  ...
                  if (j1 < i - 1) {
                     ...
                     if (par1World.isAirBlock(par3 + 1, par4 + j1, par5) || j2 == Block.leaves.blockID) {
                        this.a(par1World, par3 + 1, par4 + j1, par5, Block.wood.blockID, this.woodMetadata);
                        if (j1 > 0) {
                           if (par2Random.nextInt(3) > 0 && par1World.isAirBlock(par3 + 2, par4 + j1, par5)) {
                              this.a(par1World, par3 + 2, par4 + j1, par5, Block.vine.blockID, 2);
                           }

                           if (par2Random.nextInt(3) > 0 && par1World.isAirBlock(par3 + 1, par4 + j1, par5 - 1)) {
                              this.a(par1World, par3 + 1, par4 + j1, par5 - 1, Block.vine.blockID, 1);
                           }
                        }
                     }
                     ...
                     if (par1World.isAirBlock(par3 + 1, par4 + j1, par5 + 1) || j2 == Block.leaves.blockID) {
                        this.a(par1World, par3 + 1, par4 + j1, par5 + 1, Block.wood.blockID, this.woodMetadata);
                        if (j1 > 0) {
                           if (par2Random.nextInt(3) > 0 && par1World.isAirBlock(par3 + 2, par4 + j1, par5 + 1)) {
                              this.a(par1World, par3 + 2, par4 + j1, par5 + 1, Block.vine.blockID, 2);
                           }

                           if (par2Random.nextInt(3) > 0 && par1World.isAirBlock(par3 + 1, par4 + j1, par5 + 2)) {
                              this.a(par1World, par3 + 1, par4 + j1, par5 + 2, Block.vine.blockID, 4);
                           }
                        }
                     }
                     ...
                     if (par1World.isAirBlock(par3, par4 + j1, par5 + 1) || j2 == Block.leaves.blockID) {
                        this.a(par1World, par3, par4 + j1, par5 + 1, Block.wood.blockID, this.woodMetadata);
                        if (j1 > 0) {
                           if (par2Random.nextInt(3) > 0 && par1World.isAirBlock(par3 - 1, par4 + j1, par5 + 1)) {
                              this.a(par1World, par3 - 1, par4 + j1, par5 + 1, Block.vine.blockID, 8);
                           }

                           if (par2Random.nextInt(3) > 0 && par1World.isAirBlock(par3, par4 + j1, par5 + 2)) {
                              this.a(par1World, par3, par4 + j1, par5 + 2, Block.vine.blockID, 4);
                           }
                        }
                     }
                  }
   ...
   private void attemptToPlaceStump(World world, int i, int j, int k) {
      ...
      if (iTrunkBlockId == Block.wood.blockID) {
         ...
         if (iTrunkMetadata == this.woodMetadata) {
            world.setBlockMetadataWithClient(i, j, k, this.woodMetadata | 12);
         }
      }
   }
         ...
         for (int l = par2 - k; l <= par2 + k + 1; l++) {
            ...
            for (int j1 = par3 - k; j1 <= par3 + k + 1; j1++) {
               ...
               if ((i1 >= 0 || k1 >= 0 || i1 * i1 + k1 * k1 <= k * k)
                  && (i1 <= 0 && k1 <= 0 || i1 * i1 + k1 * k1 <= (k + 1) * (k + 1))
                  && (par6Random.nextInt(4) != 0 || i1 * i1 + k1 * k1 <= (k - 1) * (k - 1))
                  && !Block.opaqueCubeLookup[par1World.getBlockId(l, i, j1)]) {
                  this.a(par1World, l, i, j1, Block.leaves.blockID, this.leavesMetadata);
               }
            }
         }
      }
