...
public class InfiniteArrowRenderer extends Render {
   ...
   public void doRender(Entity entity, double d, double d1, double d2, float f, float f1) {
      this.renderArrow((InfiniteArrowEntity)entity, d, d1, d2, f, f1);
   }

   public void renderArrow(InfiniteArrowEntity entityarrow, double d, double d1, double d2, float f, float f1) {
      if (entityarrow.prevRotationYaw != 0.0F || entityarrow.prevRotationPitch != 0.0F) {
         this.a("/btwmodtex/fcinfinitearrow.png");
         GL11.glPushMatrix();
