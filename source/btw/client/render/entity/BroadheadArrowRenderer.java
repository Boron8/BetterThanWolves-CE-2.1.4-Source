...
public class BroadheadArrowRenderer extends Render {
   ...
   public void doRender(Entity entity, double d, double d1, double d2, float f, float f1) {
      this.renderArrow((BroadheadArrowEntity)entity, d, d1, d2, f, f1);
   }

   public void renderArrow(BroadheadArrowEntity entityarrow, double d, double d1, double d2, float f, float f1) {
      if (entityarrow.prevRotationYaw != 0.0F || entityarrow.prevRotationPitch != 0.0F) {
         this.a("/btwmodtex/fcbroadhead.png");
         GL11.glPushMatrix();
