...
public class PlayerArmorModel extends ModelBiped {
   ...
   public void render(Entity entity, float par2, float par3, float par4, float par5, float par6, float par7) {
      ...
      if (iFatPenalty == 0) {
         ...
         if (iFatPenalty == 1) {
            this.bipedBody.renderWithScaleToBaseModel(par7, 1.0625F, 1.0F, 1.4F);
         } else if (iFatPenalty == 2) {
            this.bipedBody.renderWithScaleToBaseModel(par7, 1.125F, 1.0F, 1.8F);
         } else if (iFatPenalty == 3) {
            this.bipedBody.renderWithScaleToBaseModel(par7, 1.1875F, 1.0F, 2.2F);
         } else {
            this.bipedBody.renderWithScaleToBaseModel(par7, 1.25F, 1.0F, 2.6F);
         }
