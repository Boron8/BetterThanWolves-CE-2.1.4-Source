...
public class CorpseEyeEntity extends Entity {
   ...
   private static final int VEHICLE_SPAWN_PACKET_TYPE = 120;
   ...
   public void moveTowards(double par1, int par3, double par4) {
      ...
      if (var10 > 8.0F) {
         this.targetX = this.posX + var6 / var10 * 8.0;
         this.targetZ = this.posZ + var8 / var10 * 8.0;
         this.targetY = this.posY;
      } else {
         this.targetX = par1;
         this.targetY = par3 + 1.0;
         this.targetZ = par4;
      }
   ...
   public void onUpdate() {
      ...
      if (!this.worldObj.isRemote) {
         ...
         if (this.despawnTimer > 80 && !this.worldObj.isRemote) {
            this.w();
            this.checkForDropCoupledItem();
         }
      }
   }

   protected void checkForDropCoupledItem() {
      if (this.itemDamage < 9) {
