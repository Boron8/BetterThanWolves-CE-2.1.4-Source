...
public class BufferedBlockCipher {
   ...
   public BufferedBlockCipher(BlockCipher var1) {
      ...
      if (this.pgpCFB) {
         ...
         this.partialBlockOkay = var3 > 0
            && (
               var2.startsWith("CFB", var3)
                  || var2.startsWith("OFB", var3)
                  || var2.startsWith("OpenPGP", var3)
                  || var2.startsWith("SIC", var3)
                  || var2.startsWith("GCTR", var3)
            );
      }
   }
   ...
   public int processByte(byte[] var1, int var2, int var3, byte[] var4, int var5) {
      if (var3 < 0) {
