         ...
         if (this.decode_ready) {
            ...
            if (var4 > 0) {
               ...
               if (this.vb.synthesis(var3) == 0) {
                  int var7 = this.vd.synthesis_pcmout((float[][][])null, null);
                  this.vd.synthesis_blockin(this.vb);
                  this.samptrack = this.samptrack + (this.vd.synthesis_pcmout((float[][][])null, null) - var7);
                  this.bittrack = this.bittrack + var3.bytes * 8;
                  if (var5 != -1L && var3.e_o_s == 0) {
                     var7 = this.seekable ? this.current_link : 0;
                     int var8 = this.vd.synthesis_pcmout((float[][][])null, null);
                     var5 -= var8;
