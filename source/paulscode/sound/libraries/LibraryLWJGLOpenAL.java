...
public class LibraryLWJGLOpenAL extends Library {
   ...
   protected Channel createChannel(int var1) {
      ...
      return AL10.alGetError() != 0 ? null : new ChannelLWJGLOpenAL(var1, var3);
   }
   ...
   public void cleanup() {
      ...
      for (String var3 : this.bufferMap.keySet()) {
               ...
               if (this.errorCheck(var4 == null, "Sound buffer null in method 'loadSound'")) {
                  ...
                  if (this.errorCheck(AL10.alGetError() != 0, "alGenBuffers error when loading " + var1.getFilename())) {
                     ...
                     AL10.alBufferData(
                        var7.get(0),
                        var6,
                        (ByteBuffer)((Buffer)BufferUtils.createByteBuffer(var4.audioData.length).put(var4.audioData)).flip(),
                        (int)var5.getSampleRate()
                     );
                     if (this.errorCheck(AL10.alGetError() != 0, "alBufferData error when loading " + var1.getFilename())
                        && this.errorCheck(var7 == null, "Sound buffer was not created for " + var1.getFilename())) {
                        return false;
                     } else {
                        this.ALBufferMap.put(var1.getFilename(), var7);
                        return true;
                     }
                  }
               }
      ...
      if (this.errorCheck(var2 == null, "Identifier not specified in method 'loadSound'")) {
         ...
         if (this.errorCheck(AL10.alGetError() != 0, "alGenBuffers error when saving " + var2)) {
            ...
            AL10.alBufferData(
               var5.get(0),
               var4,
               (ByteBuffer)((Buffer)BufferUtils.createByteBuffer(var1.audioData.length).put(var1.audioData)).flip(),
               (int)var3.getSampleRate()
            );
            if (this.errorCheck(AL10.alGetError() != 0, "alBufferData error when saving " + var2)
               && this.errorCheck(var5 == null, "Sound buffer was not created for " + var2)) {
               return false;
            } else {
   ...
   public void newSource(boolean var1, boolean var2, boolean var3, String var4, FilenameURL var5, float var6, float var7, float var8, int var9, float var10) {
      ...
      this.sourceMap
         .put(var4, new SourceLWJGLOpenAL(this.listenerPositionAL, var11, var1, var2, var3, var4, var5, var12, var6, var7, var8, var9, var10, false));
   }
         ...
         while (var3.hasNext()) {
            ...
            if (var5 != null) {
               ...
               if (var5.toStream || var6 != null) {
                  this.sourceMap
                     .put(var4, new SourceLWJGLOpenAL(this.listenerPositionAL, (IntBuffer)this.ALBufferMap.get(var5.filenameURL.getFilename()), var5, var6));
               }
            }
         }
      }
