...
public class SourceJavaSound extends Source {
   ...
   public boolean preLoad() {
      if (this.codec == null) {
            ...
            synchronized (this.soundSequenceLock) {
               while (!this.nextBuffers.isEmpty()) {
                  ...
                  if (this.soundBuffer != null && this.soundBuffer.audioData != null) {
                     var7.add(this.soundBuffer.audioData);
                  }
               }
            }
         } else {
         ...
         this.positionChanged();
         this.channel.preLoadBuffers(var7);
         this.preLoad = false;
         return true;
      }
   }
   ...
   public void calculateGain() {
      ...
      this.distanceFromListener = (float)Math.sqrt(var1 * var1 + var2 * var2 + var3 * var3);
      ...
      this.gain = this.gain * (this.sourceVolume * SoundSystemConfig.getMasterGain() * Math.abs(this.fadeOutGain) * this.fadeInGain);
   ...
   public void calculatePan() {
      ...
      Object var5 = null;
      float var4 = (float)Math.atan2(var2, var3);
      this.pan = (float)(-Math.sin(var4));
      if (this.channel != null && this.channel.attachedSource == this && this.channelJavaSound != null) {
         if (this.attModel == 0) {
