...
public class ChannelLWJGLOpenAL extends Channel {
   ...
   public boolean preLoadBuffers(LinkedList var1) {
      if (this.errorCheck(this.channelType != 1, "Buffers may only be queued for streaming sources.")) {
         ...
         if (var4 > 0) {
            IntBuffer var2 = BufferUtils.createIntBuffer(var4);
         ...
         IntBuffer var10 = BufferUtils.createIntBuffer(var1.size());
         ...
         if (this.errorCheck(this.checkALError(), "Error generating stream buffers in method 'preLoadBuffers'")) {
            ...
            for (int var6 = 0; var6 < var1.size(); var6++) {
               var5 = (ByteBuffer)((Buffer)BufferUtils.createByteBuffer(((byte[])var1.get(var6)).length).put((byte[])var1.get(var6))).flip();

               try {
                  AL10.alBufferData(var10.get(var6), this.ALformat, (ByteBuffer)var5, this.sampleRate);
            ...
            try {
               AL10.alSourceQueueBuffers(this.ALSource.get(0), var10);
   ...
   public boolean queueBuffer(byte[] var1) {
      if (this.errorCheck(this.channelType != 1, "Buffers may only be queued for streaming sources.")) {
         ...
         ByteBuffer var2 = (ByteBuffer)((Buffer)BufferUtils.createByteBuffer(var1.length).put(var1)).flip();
         ...
         if (this.checkALError()) {
            ...
            if (AL10.alIsBuffer(var3.get(0))) {
               this.millisPreviouslyPlayed = this.millisPreviouslyPlayed + this.millisInBuffer(var3.get(0));
            }
   ...
   public float millisInBuffer(int var1) {
      return (float)AL10.alGetBufferi(var1, 8196) / AL10.alGetBufferi(var1, 8195) / (AL10.alGetBufferi(var1, 8194) / 8.0F) / this.sampleRate * 1000.0F;
   }

   @Override
   public float millisecondsPlayed() {
      float var1 = AL10.alGetSourcei(this.ALSource.get(0), 4134);
      float var2 = 1.0F;
      ...
      var1 = var1 / var2 / this.sampleRate * 1000.0F;
   ...
   public boolean playing() {
      int var1 = AL10.alGetSourcei(this.ALSource.get(0), 4112);
      return this.checkALError() ? false : var1 == 4114;
   }
