...
public class SoundSystem {
   ...
   protected void init(Class var1) {
      this.message("", 0);
   ...
   public boolean switchLibrary(Class var1) {
      synchronized (SoundSystemConfig.THREAD_SYNC) {
         initialized(true, false);
         HashMap var3 = null;
   ...
   public boolean newLibrary(Class var1) {
      initialized(true, false);
      this.CommandQueue(new CommandObject(40, var1));
      this.commandThread.interrupt();

      for (int var2 = 0; !initialized(false, false) && var2 < 100; var2++) {
         snooze(400L);
         this.commandThread.interrupt();
      }

      if (!initialized(false, false)) {
         SoundSystemException var4 = new SoundSystemException(this.className + " did not load after 30 seconds.", 4);
         lastException(true, var4);
         throw var4;
      } else {
         SoundSystemException var3 = lastException(false, null);
         if (var3 != null) {
            throw var3;
         } else {
            return true;
   ...
   private void CommandNewSource(
      boolean var1, boolean var2, boolean var3, String var4, FilenameURL var5, float var6, float var7, float var8, int var9, float var10
   ) {
      if (this.soundLibrary != null) {
      ...
      synchronized (SoundSystemConfig.THREAD_SYNC) {
         if (var1 != null) {
            ...
            while (this.commandQueue != null && this.commandQueue.size() > 0) {
               CommandObject var4 = (CommandObject)this.commandQueue.remove(0);
               if (var4 != null) {
                  switch (var4.Command) {
                     case 1:
                     ...
                     case 10:
                        ...
                        break;
                     case 11:
                        this.CommandRawDataStream(
                           (AudioFormat)var4.objectArgs[0],
                           var4.boolArgs[0],
                           var4.stringArgs[0],
                           var4.floatArgs[0],
                           var4.floatArgs[1],
                     ...
                     case 37:
                        ...
                        break;
                     case 38:
                        this.CommandSetListenerOrientation(
                           var4.floatArgs[0], var4.floatArgs[1], var4.floatArgs[2], var4.floatArgs[3], var4.floatArgs[4], var4.floatArgs[5]
                        );
                        break;
                     case 39:
            ...
            while (this.sourcePlayList != null && this.sourcePlayList.size() > 0) {
               CommandObject var7 = (CommandObject)this.sourcePlayList.remove(0);
               if (var7 != null) {
                  switch (var7.Command) {
                     case 24:
                        this.CommandPlay(var7.stringArgs[0]);
                        break;
                     case 25:
                        this.CommandFeedRawAudioData(var7.stringArgs[0], var7.buffer);
                  }
               }
            }
         ...
         if (this.soundLibrary == null) {
            ...
            if (var2 == null) {
               ...
               for (String var5 : var2.keySet()) {
                  Source var6 = (Source)var2.get(var5);
                  if (var6 != null && var6.playing()) {
                     return true;
                  }
               }
   ...
   private HashMap copySources(HashMap var1) {
      ...
      while (var3.hasNext()) {
         ...
         if (var5 != null) {
            var6.put(var4, new Source(var5, null));
         }
      }
   ...
   private static boolean initialized(boolean var0, boolean var1) {
      synchronized (SoundSystemConfig.THREAD_SYNC) {
         if (var0) {
            initialized = var1;
         }
