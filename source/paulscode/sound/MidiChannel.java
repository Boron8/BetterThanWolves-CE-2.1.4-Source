...
public class MidiChannel implements MetaEventListener {
      ...
      if (this.fadeOutGain == -1.0F && this.fadeInGain == 1.0F) {
         ...
         if (this.fadeOutGain >= 0.0F) {
            if (this.fadeOutMilis == 0L) {
               ...
               float var6 = (float)var3 / (float)this.fadeOutMilis;
               this.fadeOutGain -= var6;
               if (this.fadeOutGain <= 0.0F) {
                  this.fadeOutGain = -1.0F;
                  this.fadeInGain = 0.0F;
                  if (!this.incrementSequence()) {
            ...
            if (this.fadeInGain < 1.0F) {
               ...
               if (this.fadeInMilis == 0L) {
                  ...
                  float var5 = (float)var3 / (float)this.fadeInMilis;
   ...
   public void resetGain() {
      ...
      if (this.synthesizer != null) {
         javax.sound.midi.MidiChannel[] var2 = this.synthesizer.getChannels();
         ...
         try {
            ...
            for (int var10 = 0; var10 < 16; var10++) {
               var7.setMessage(176, var10, 7, var1);
         ...
         javax.sound.midi.MidiChannel[] var9 = this.synthesizer.getChannels();

         for (int var12 = 0; var9 != null && var12 < var9.length; var12++) {
            var9[var12].controlChange(7, var1);
         }
      } else {
         try {
            Receiver var8 = MidiSystem.getReceiver();
            ShortMessage var11 = new ShortMessage();

            for (int var4 = 0; var4 < 16; var4++) {
               var11.setMessage(176, var4, 7, var1);
               var8.send(var11, -1L);
            }
         } catch (Exception var5) {
