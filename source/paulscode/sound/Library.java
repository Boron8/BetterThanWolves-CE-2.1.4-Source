...
public class Library {
   ...
   public void init() {
      ...
      for (int var2 = 0; var2 < SoundSystemConfig.getNumberStreamingChannels(); var2++) {
      ...
      for (int var5 = 0; var5 < SoundSystemConfig.getNumberNormalChannels(); var5++) {
   ...
   public void newSource(boolean var1, boolean var2, boolean var3, String var4, FilenameURL var5, float var6, float var7, float var8, int var9, float var10) {
      this.sourceMap.put(var4, new Source(var1, var2, var3, var4, var5, null, var6, var7, var8, var9, var10, false));
   }
   ...
   public void quickPlay(
      ...
      this.sourceMap.put(var4, new Source(var1, var2, var3, var4, var5, null, var6, var7, var8, var9, var10, var11));
   }
   ...
   public float millisecondsPlayed(String var1) {
      if (var1 == null || var1.equals("")) {
         ...
         return -1.0F;
      } else if (this.midiSourcename(var1)) {
   ...
   public void setListenerPosition(float var1, float var2, float var3) {
      ...
      for (String var6 : this.sourceMap.keySet()) {
   ...
   public void setListenerOrientation(float var1, float var2, float var3, float var4, float var5, float var6) {
      ...
      for (String var9 : this.sourceMap.keySet()) {
      ...
      if (var1 != null) {
         ...
         while (var3.hasNext()) {
            ...
            if (var5 != null) {
               ...
               this.sourceMap.put(var4, new Source(var5, null));
            }
         }
      }
   }
         ...
         if (var2 == null) {
            ...
            for (int var11 = 0; var11 < var4; var11++) {
               ...
               if (var13 == null) {
                  ...
                  var15 = (Source)this.sourceMap.get(var13);
               }

               if (var15 == null || !var15.playing()) {
                  if (var1.toStream) {
   ...
   public void replaySources() {
      for (String var3 : this.sourceMap.keySet()) {
         Source var4 = (Source)this.sourceMap.get(var3);
   ...
   public void checkFadeVolumes() {
      ...
      for (int var3 = 0; var3 < this.streamingChannels.size(); var3++) {
         Channel var1 = (Channel)this.streamingChannels.get(var3);
         if (var1 != null) {
            Source var2 = var1.attachedSource;
            if (var2 != null) {
               var2.checkFadeOut();
            }
         }
   ...
   public boolean midiSourcename(String var1) {
      if (this.midiChannel == null || var1 == null) {
         return false;
      } else {
         return this.midiChannel.getSourcename() == null || var1.equals("") ? false : var1.equals(this.midiChannel.getSourcename());
      }
   }
